  ...
  1b:	31 db                	xor    %ebx,%ebx
{
  ...
  5b:	83 c4 10             	add    $0x10,%esp
    if(fork() > 0)
  5e:	e8 14 04 00 00       	call   477 <fork>
  ...
  a2:	50                   	push   %eax
  a3:	e8 17 04 00 00       	call   4bf <open>
...
//    printf(fd, "%d\n", i);
  ...
  b8:	56                   	push   %esi
  b9:	57                   	push   %edi
  ba:	e8 e0 03 00 00       	call   49f <write>
  for(i = 0; i < 20; i++)
  ...
  ca:	57                   	push   %edi
  cb:	e8 d7 03 00 00       	call   4a7 <close>
  ...
  ed:	50                   	push   %eax
  ee:	e8 cc 03 00 00       	call   4bf <open>
 ...
 108:	56                   	push   %esi
 109:	57                   	push   %edi
 10a:	e8 88 03 00 00       	call   497 <read>
  for (i = 0; i < 20; i++)
 ...
 11a:	57                   	push   %edi
 11b:	e8 87 03 00 00       	call   4a7 <close>

  wait();
 120:	e8 62 03 00 00       	call   487 <wait>

  exit();
 125:	e8 55 03 00 00       	call   47f <exit>
  path[8] += i;
 ...
 269:	31 db                	xor    %ebx,%ebx
{
 ...
 275:	57                   	push   %edi
 276:	6a 00                	push   $0x0
 278:	e8 1a 02 00 00       	call   497 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2dd:	e8 dd 01 00 00       	call   4bf <open>
  if(fd < 0)
 ...
 2f1:	50                   	push   %eax
 2f2:	e8 e0 01 00 00       	call   4d7 <fstat>
  close(fd);
 2f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2fa:	89 c6                	mov    %eax,%esi
  close(fd);
 2fc:	e8 a6 01 00 00       	call   4a7 <close>
  return r;
...
char* strcat(char* dest, const char* source)
{
 ...
 393:	53                   	push   %ebx
 394:	8b 5d 08             	mov    0x8(%ebp),%ebx
 397:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  for(n = 0; s[n]; n++)
 39a:	80 3b 00             	cmpb   $0x0,(%ebx)
 39d:	74 41                	je     3e0 <strcat+0x50>
 39f:	8d 53 01             	lea    0x1(%ebx),%edx
 3a2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 3a8:	89 d0                	mov    %edx,%eax
 3aa:	83 c2 01             	add    $0x1,%edx
 3ad:	80 7a ff 00          	cmpb   $0x0,-0x1(%edx)
 3b1:	75 f5                	jne    3a8 <strcat+0x18>
	char* ptr = dest + strlen(dest);
	while (*source != '\0')
 3b3:	0f b6 11             	movzbl (%ecx),%edx
 3b6:	84 d2                	test   %dl,%dl
 3b8:	74 15                	je     3cf <strcat+0x3f>
 ...
 3c5:	83 c1 01             	add    $0x1,%ecx
	while (*source != '\0')
 3c8:	0f b6 11             	movzbl (%ecx),%edx
 3cb:	84 d2                	test   %dl,%dl
 3cd:	75 f1                	jne    3c0 <strcat+0x30>
	*ptr = '\0';
 ...
 3d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(n = 0; s[n]; n++)
 3e0:	89 d8                	mov    %ebx,%eax
	while (*source != '\0')
 3e2:	eb e4                	jmp    3c8 <strcat+0x38>
...
char *strtok(char *str, const char *delim) {
 3f7:	8b 7d 0c             	mov    0xc(%ebp),%edi
 3fa:	56                   	push   %esi
 3fb:	53                   	push   %ebx
    if (str != NULL) {
 3fc:	85 c0                	test   %eax,%eax
 3fe:	74 6d                	je     46d <strtok+0x7d>
        last_token = str;
 400:	8b 45 08             	mov    0x8(%ebp),%eax
 403:	a3 9c 0c 00 00       	mov    %eax,0xc9c
    }

    while (*last_token != '\0') {
 408:	8b 45 08             	mov    0x8(%ebp),%eax
 40b:	0f b6 08             	movzbl (%eax),%ecx
 40e:	84 c9                	test   %cl,%cl
 410:	74 54                	je     466 <strtok+0x76>
        const char *d = delim;
        while (*d != '\0') {
 412:	0f b6 37             	movzbl (%edi),%esi
 415:	8d 76 00             	lea    0x0(%esi),%esi
 418:	89 f0                	mov    %esi,%eax
 41a:	89 fa                	mov    %edi,%edx
 41c:	84 c0                	test   %al,%al
 41e:	75 13                	jne    433 <strtok+0x43>
 420:	eb 2e                	jmp    450 <strtok+0x60>
 ...
 431:	74 1d                	je     450 <strtok+0x60>
            if (*last_token == *d) {
 433:	38 c8                	cmp    %cl,%al
 435:	75 f1                	jne    428 <strtok+0x38>
        }
        if (delim_found) {
            *last_token = '\0';
 437:	8b 45 08             	mov    0x8(%ebp),%eax
 43a:	c6 00 00             	movb   $0x0,(%eax)
 ...
 442:	5f                   	pop    %edi
            last_token++;
 443:	a3 9c 0c 00 00       	mov    %eax,0xc9c
}
 448:	5d                   	pop    %ebp
 449:	c3                   	ret    
 ...
 457:	0f b6 08             	movzbl (%eax),%ecx
 45a:	84 c9                	test   %cl,%cl
 45c:	75 ba                	jne    418 <strtok+0x28>
 45e:	8b 45 08             	mov    0x8(%ebp),%eax
 461:	a3 9c 0c 00 00       	mov    %eax,0xc9c
}
 466:	5b                   	pop    %ebx
    return NULL;
 ...
 46c:	c3                   	ret    
    while (*last_token != '\0') {
 46d:	a1 9c 0c 00 00       	mov    0xc9c,%eax
 472:	89 45 08             	mov    %eax,0x8(%ebp)
 475:	eb 91                	jmp    408 <strtok+0x18>
 ...
 52c:	89 d1                	mov    %edx,%ecx
{
 ...
 559:	0f b6 92 7c 09 00 00 	movzbl 0x97c(%edx),%edx
 ...
 59e:	56                   	push   %esi
 59f:	57                   	push   %edi
 5a0:	e8 fa fe ff ff       	call   49f <write>
  while(--i >= 0)
 ...
 5d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 615:	57                   	push   %edi
 616:	56                   	push   %esi
 617:	e8 83 fe ff ff       	call   49f <write>
 ...
 66e:	e8 2c fe ff ff       	call   49f <write>
        putc(fd, c);
 ...
 6eb:	57                   	push   %edi
 6ec:	56                   	push   %esi
 6ed:	e8 ad fd ff ff       	call   49f <write>
        while(*s != 0){
 ...
 72c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 72f:	e8 6b fd ff ff       	call   49f <write>
        ap++;
 ...
 757:	90                   	nop
          s = "(null)";
 758:	ba 1b 09 00 00       	mov    $0x91b,%edx
        while(*s != 0){
 ...
 771:	a1 a0 0c 00 00       	mov    0xca0,%eax
{
 ...
 7b1:	5b                   	pop    %ebx
  freep = p;
 7b2:	89 15 a0 0c 00 00    	mov    %edx,0xca0
}
 7b8:	5e                   	pop    %esi
 7b9:	5f                   	pop    %edi
 7ba:	5d                   	pop    %ebp
 ...
 7e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7ec:	89 15 a0 0c 00 00    	mov    %edx,0xca0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 809:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 80c:	8b 3d a0 0c 00 00    	mov    0xca0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 84f:	73 4f                	jae    8a0 <malloc+0xa0>
    ...
    if(p == freep)
 851:	8b 3d a0 0c 00 00    	mov    0xca0,%edi
 ...
 863:	e8 9f fc ff ff       	call   507 <sbrk>
  if(p == (char*)-1)
 ...
 87a:	e8 f1 fe ff ff       	call   770 <free>
  return freep;
 87f:	8b 15 a0 0c 00 00    	mov    0xca0,%edx
 ...
 8bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8c0:	c7 05 a0 0c 00 00 a4 	movl   $0xca4,0xca0
 8c7:	0c 00 00 
    base.s.size = 0;
 8ca:	bf a4 0c 00 00       	mov    $0xca4,%edi
    base.s.ptr = freep = prevp = &base;
 8cf:	c7 05 a4 0c 00 00 a4 	movl   $0xca4,0xca4
 8d6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8db:	c7 05 a8 0c 00 00 00 	movl   $0x0,0xca8
 8e2:	00 00 00 
    if(p->s.size >= nunits){

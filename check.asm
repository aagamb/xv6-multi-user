...
int main(){
   ...
   f:	53                   	push   %ebx
  10:	51                   	push   %ecx
	printf(1, "gello this should print");	
	strcpy(dest, src);
  11:	8d 5d a8             	lea    -0x58(%ebp),%ebx
int main(){
  14:	83 ec 58             	sub    $0x58,%esp
	char src[30] = "hello aagam";
  17:	66 89 45 c4          	mov    %ax,-0x3c(%ebp)
	printf(1, "gello this should print");	
  1b:	68 38 08 00 00       	push   $0x838
  20:	6a 01                	push   $0x1
	char src[30] = "hello aagam";
  22:	c7 45 a8 68 65 6c 6c 	movl   $0x6c6c6568,-0x58(%ebp)
  29:	c7 45 ac 6f 20 61 61 	movl   $0x6161206f,-0x54(%ebp)
  30:	c7 45 b0 67 61 6d 00 	movl   $0x6d6167,-0x50(%ebp)
  37:	c7 45 b4 00 00 00 00 	movl   $0x0,-0x4c(%ebp)
  3e:	c7 45 b8 00 00 00 00 	movl   $0x0,-0x48(%ebp)
  45:	c7 45 bc 00 00 00 00 	movl   $0x0,-0x44(%ebp)
  4c:	c7 45 c0 00 00 00 00 	movl   $0x0,-0x40(%ebp)
	printf(1, "gello this should print");	
  53:	e8 b8 04 00 00       	call   510 <printf>
	strcpy(dest, src);
  58:	8d 45 c6             	lea    -0x3a(%ebp),%eax
  5b:	5a                   	pop    %edx
  5c:	59                   	pop    %ecx
  5d:	53                   	push   %ebx
  5e:	50                   	push   %eax
  5f:	e8 1c 00 00 00       	call   80 <strcpy>
	printf(1, "%s", src);
  64:	83 c4 0c             	add    $0xc,%esp
  67:	53                   	push   %ebx
  68:	68 50 08 00 00       	push   $0x850
  6d:	6a 01                	push   $0x1
  6f:	e8 9c 04 00 00       	call   510 <printf>

exit();
  74:	e8 46 03 00 00       	call   3bf <exit>
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
  7f:	90                   	nop
...
stat(const char *n, struct stat *st)
{
 ...
 21d:	e8 dd 01 00 00       	call   3ff <open>
  if(fd < 0)
 ...
 231:	50                   	push   %eax
 232:	e8 e0 01 00 00       	call   417 <fstat>
  close(fd);
 237:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 23a:	89 c6                	mov    %eax,%esi
  close(fd);
 23c:	e8 a6 01 00 00       	call   3e7 <close>
  return r;
...
char* strcat(char* dest, const char* source)
{
 ...
 2d7:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  for(n = 0; s[n]; n++)
 2da:	80 3b 00             	cmpb   $0x0,(%ebx)
 2dd:	74 41                	je     320 <strcat+0x50>
 2df:	8d 53 01             	lea    0x1(%ebx),%edx
 2e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 2e8:	89 d0                	mov    %edx,%eax
 2ea:	83 c2 01             	add    $0x1,%edx
 2ed:	80 7a ff 00          	cmpb   $0x0,-0x1(%edx)
 2f1:	75 f5                	jne    2e8 <strcat+0x18>
	char* ptr = dest + strlen(dest);
	while (*source != '\0')
 2f3:	0f b6 11             	movzbl (%ecx),%edx
 2f6:	84 d2                	test   %dl,%dl
 2f8:	74 15                	je     30f <strcat+0x3f>
 2fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		*ptr++ = *source++;
 300:	88 10                	mov    %dl,(%eax)
 302:	83 c0 01             	add    $0x1,%eax
 305:	83 c1 01             	add    $0x1,%ecx
	while (*source != '\0')
 308:	0f b6 11             	movzbl (%ecx),%edx
 30b:	84 d2                	test   %dl,%dl
 30d:	75 f1                	jne    300 <strcat+0x30>
	*ptr = '\0';
...
char *strtok(char *str, const char *delim) {
 337:	8b 7d 0c             	mov    0xc(%ebp),%edi
 33a:	56                   	push   %esi
 33b:	53                   	push   %ebx
    if (str != NULL) {
 33c:	85 c0                	test   %eax,%eax
 33e:	74 6d                	je     3ad <strtok+0x7d>
        last_token = str;
 340:	8b 45 08             	mov    0x8(%ebp),%eax
 343:	a3 c8 0b 00 00       	mov    %eax,0xbc8
    }

    while (*last_token != '\0') {
 348:	8b 45 08             	mov    0x8(%ebp),%eax
 34b:	0f b6 08             	movzbl (%eax),%ecx
 34e:	84 c9                	test   %cl,%cl
 350:	74 54                	je     3a6 <strtok+0x76>
        const char *d = delim;
        while (*d != '\0') {
 352:	0f b6 37             	movzbl (%edi),%esi
 355:	8d 76 00             	lea    0x0(%esi),%esi
 358:	89 f0                	mov    %esi,%eax
 35a:	89 fa                	mov    %edi,%edx
 35c:	84 c0                	test   %al,%al
 35e:	75 13                	jne    373 <strtok+0x43>
 360:	eb 2e                	jmp    390 <strtok+0x60>
 ...
 371:	74 1d                	je     390 <strtok+0x60>
            if (*last_token == *d) {
 373:	38 c8                	cmp    %cl,%al
 375:	75 f1                	jne    368 <strtok+0x38>
        }
        if (delim_found) {
            *last_token = '\0';
 ...
 382:	5f                   	pop    %edi
            last_token++;
 383:	a3 c8 0b 00 00       	mov    %eax,0xbc8
}
 388:	5d                   	pop    %ebp
 389:	c3                   	ret    
 ...
 397:	0f b6 08             	movzbl (%eax),%ecx
 39a:	84 c9                	test   %cl,%cl
 39c:	75 ba                	jne    358 <strtok+0x28>
 39e:	8b 45 08             	mov    0x8(%ebp),%eax
 3a1:	a3 c8 0b 00 00       	mov    %eax,0xbc8
}
 3a6:	5b                   	pop    %ebx
    return NULL;
 ...
 3ac:	c3                   	ret    
    while (*last_token != '\0') {
 3ad:	a1 c8 0b 00 00       	mov    0xbc8,%eax
 3b2:	89 45 08             	mov    %eax,0x8(%ebp)
 3b5:	eb 91                	jmp    348 <strtok+0x18>
 ...
 46c:	89 d1                	mov    %edx,%ecx
{
 ...
 4de:	56                   	push   %esi
 4df:	57                   	push   %edi
 4e0:	e8 fa fe ff ff       	call   3df <write>
  while(--i >= 0)
 ...
 519:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 555:	57                   	push   %edi
 556:	56                   	push   %esi
 557:	e8 83 fe ff ff       	call   3df <write>
 ...
 589:	ff 24 85 5c 08 00 00 	jmp    *0x85c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5ae:	e8 2c fe ff ff       	call   3df <write>
        putc(fd, c);
 ...
 5bf:	57                   	push   %edi
 5c0:	56                   	push   %esi
 5c1:	e8 19 fe ff ff       	call   3df <write>
        putc(fd, c);
 ...
 62b:	57                   	push   %edi
 62c:	56                   	push   %esi
 62d:	e8 ad fd ff ff       	call   3df <write>
        while(*s != 0){
 ...
 66c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 66f:	e8 6b fd ff ff       	call   3df <write>
        ap++;
 ...
 697:	90                   	nop
          s = "(null)";
 698:	ba 53 08 00 00       	mov    $0x853,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b1:	a1 cc 0b 00 00       	mov    0xbcc,%eax
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	89 15 cc 0b 00 00    	mov    %edx,0xbcc
}
 6f8:	5e                   	pop    %esi
 6f9:	5f                   	pop    %edi
 6fa:	5d                   	pop    %ebp
 ...
 729:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 72c:	89 15 cc 0b 00 00    	mov    %edx,0xbcc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 3d cc 0b 00 00    	mov    0xbcc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 4f                	jae    7e0 <malloc+0xa0>
    ...
    if(p == freep)
 791:	8b 3d cc 0b 00 00    	mov    0xbcc,%edi
 ...
 7a3:	e8 9f fc ff ff       	call   447 <sbrk>
  if(p == (char*)-1)
 ...
 7ba:	e8 f1 fe ff ff       	call   6b0 <free>
  return freep;
 7bf:	8b 15 cc 0b 00 00    	mov    0xbcc,%edx
 ...
 807:	0b 00 00 
    base.s.size = 0;
 80a:	bf d0 0b 00 00       	mov    $0xbd0,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 819:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 81b:	c7 05 d4 0b 00 00 00 	movl   $0x0,0xbd4
 822:	00 00 00 
    if(p->s.size >= nunits){

...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      2b:	e8 1f 0f 00 00       	call   f4f <open>
...
fork1(void)
{
  ...
  pid = fork();
      50:	e8 b2 0e 00 00       	call   f07 <fork>
  if(pid == -1)
    ...
    wait();
      62:	e8 b0 0e 00 00       	call   f17 <wait>
  printf(2, "$ ");
  ...
  if(buf[0] == 0) // EOF
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      b5:	50                   	push   %eax
      b6:	e8 7c 0e 00 00       	call   f37 <close>
      break;
      ...
      if(chdir(buf+3) < 0)
      f0:	e8 8a 0e 00 00       	call   f7f <chdir>
  ...
  exit();
     11a:	e8 f0 0d 00 00       	call   f0f <exit>
    panic("fork");
...
00000170 <panic>:
{
  ...
  exit();
     185:	e8 85 0d 00 00       	call   f0f <exit>
...
00000190 <fork1>:
{
  ...
  pid = fork();
     196:	e8 6c 0d 00 00       	call   f07 <fork>
  if(pid == -1)
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     1dc:	52                   	push   %edx
     1dd:	50                   	push   %eax
     1de:	e8 64 0d 00 00       	call   f47 <exec>
    ...
    break;
     ...
     1ff:	90                   	nop
    exit();
     200:	e8 0a 0d 00 00       	call   f0f <exit>
    if(fork1() == 0)
    ...
    if(pipe(p) < 0)
     ...
     219:	50                   	push   %eax
     21a:	e8 00 0d 00 00       	call   f1f <pipe>
    ...
    close(p[0]);
     ...
     24a:	e8 e8 0c 00 00       	call   f37 <close>
    close(p[1]);
     24f:	58                   	pop    %eax
     250:	ff 75 f4             	push   -0xc(%ebp)
     253:	e8 df 0c 00 00       	call   f37 <close>
    wait();
     258:	e8 ba 0c 00 00       	call   f17 <wait>
    wait();
     25d:	e8 b5 0c 00 00       	call   f17 <wait>
    break;
    ...
    wait();
     270:	e8 a2 0c 00 00       	call   f17 <wait>
    runcmd(lcmd->right);
    ...
    close(rcmd->fd);
     ...
     286:	e8 ac 0c 00 00       	call   f37 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     28b:	58                   	pop    %eax
     28c:	5a                   	pop    %edx
     28d:	ff 73 10             	push   0x10(%ebx)
     290:	ff 73 08             	push   0x8(%ebx)
     293:	e8 b7 0c 00 00       	call   f4f <open>
    ...
    panic("runcmd");
     ...
     2c2:	e8 99 0d 00 00       	call   1060 <printf>
      exit();
     2c7:	e8 43 0c 00 00       	call   f0f <exit>
      panic("pipe");
     ...
     2dc:	6a 01                	push   $0x1
     2de:	e8 54 0c 00 00       	call   f37 <close>
      dup(p[1]);
     2e3:	58                   	pop    %eax
     2e4:	ff 75 f4             	push   -0xc(%ebp)
     2e7:	e8 9b 0c 00 00       	call   f87 <dup>
      close(p[0]);
     2ec:	58                   	pop    %eax
     2ed:	ff 75 f0             	push   -0x10(%ebp)
     2f0:	e8 42 0c 00 00       	call   f37 <close>
      close(p[1]);
     2f5:	58                   	pop    %eax
     2f6:	ff 75 f4             	push   -0xc(%ebp)
     2f9:	e8 39 0c 00 00       	call   f37 <close>
      runcmd(pcmd->left);
     2fe:	5a                   	pop    %edx
     ...
     30a:	6a 00                	push   $0x0
     30c:	e8 26 0c 00 00       	call   f37 <close>
      dup(p[0]);
     311:	5a                   	pop    %edx
     312:	ff 75 f0             	push   -0x10(%ebp)
     315:	e8 6d 0c 00 00       	call   f87 <dup>
      close(p[0]);
     31a:	59                   	pop    %ecx
     31b:	ff 75 f0             	push   -0x10(%ebp)
     31e:	e8 14 0c 00 00       	call   f37 <close>
      close(p[1]);
     323:	58                   	pop    %eax
     324:	ff 75 f4             	push   -0xc(%ebp)
     327:	e8 0b 0c 00 00       	call   f37 <close>
      runcmd(pcmd->right);
     32c:	58                   	pop    %eax
     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 14 1b 00 00       	push   $0x1b14
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ed:	50                   	push   %eax
     4ee:	68 14 1b 00 00       	push   $0x1b14
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     52e:	50                   	push   %eax
     52f:	68 0c 1b 00 00       	push   $0x1b0c
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     550:	56                   	push   %esi
     551:	68 14 1b 00 00       	push   $0x1b14
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 14 1b 00 00       	push   $0x1b14
     ...
     cf9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     d05:	57                   	push   %edi
     d06:	6a 00                	push   $0x0
     d08:	e8 1a 02 00 00       	call   f27 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d6d:	e8 dd 01 00 00       	call   f4f <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d81:	50                   	push   %eax
     d82:	e8 e0 01 00 00       	call   f67 <fstat>
  close(fd);
     d87:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     d8a:	89 c6                	mov    %eax,%esi
  close(fd);
     d8c:	e8 a6 01 00 00       	call   f37 <close>
  return r;
...
char* strcat(char* dest, const char* source)
{
     ...
     e23:	53                   	push   %ebx
     e24:	8b 5d 08             	mov    0x8(%ebp),%ebx
     e27:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  for(n = 0; s[n]; n++)
     e2a:	80 3b 00             	cmpb   $0x0,(%ebx)
     e2d:	74 41                	je     e70 <strcat+0x50>
     e2f:	8d 53 01             	lea    0x1(%ebx),%edx
     e32:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
     e38:	89 d0                	mov    %edx,%eax
     e3a:	83 c2 01             	add    $0x1,%edx
     e3d:	80 7a ff 00          	cmpb   $0x0,-0x1(%edx)
     e41:	75 f5                	jne    e38 <strcat+0x18>
	char* ptr = dest + strlen(dest);
	while (*source != '\0')
     e43:	0f b6 11             	movzbl (%ecx),%edx
     e46:	84 d2                	test   %dl,%dl
     e48:	74 15                	je     e5f <strcat+0x3f>
     e4a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		*ptr++ = *source++;
     e50:	88 10                	mov    %dl,(%eax)
     e52:	83 c0 01             	add    $0x1,%eax
     e55:	83 c1 01             	add    $0x1,%ecx
	while (*source != '\0')
     e58:	0f b6 11             	movzbl (%ecx),%edx
     e5b:	84 d2                	test   %dl,%dl
     e5d:	75 f1                	jne    e50 <strcat+0x30>
	*ptr = '\0';
     e5f:	c6 00 00             	movb   $0x0,(%eax)
	return dest;
}
     e62:	89 d8                	mov    %ebx,%eax
     e64:	8b 5d fc             	mov    -0x4(%ebp),%ebx
     e67:	c9                   	leave  
     e68:	c3                   	ret    
     e69:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(n = 0; s[n]; n++)
     e70:	89 d8                	mov    %ebx,%eax
	while (*source != '\0')
     e72:	eb e4                	jmp    e58 <strcat+0x38>
...
char *strtok(char *str, const char *delim) {
     e87:	8b 7d 0c             	mov    0xc(%ebp),%edi
     e8a:	56                   	push   %esi
     e8b:	53                   	push   %ebx
    if (str != NULL) {
     e8c:	85 c0                	test   %eax,%eax
     e8e:	74 6d                	je     efd <strtok+0x7d>
        last_token = str;
     e90:	8b 45 08             	mov    0x8(%ebp),%eax
     e93:	a3 84 1b 00 00       	mov    %eax,0x1b84
    }

    while (*last_token != '\0') {
     e98:	8b 45 08             	mov    0x8(%ebp),%eax
     e9b:	0f b6 08             	movzbl (%eax),%ecx
     e9e:	84 c9                	test   %cl,%cl
     ea0:	74 54                	je     ef6 <strtok+0x76>
        const char *d = delim;
        while (*d != '\0') {
     ea2:	0f b6 37             	movzbl (%edi),%esi
     ea5:	8d 76 00             	lea    0x0(%esi),%esi
     ea8:	89 f0                	mov    %esi,%eax
     eaa:	89 fa                	mov    %edi,%edx
     eac:	84 c0                	test   %al,%al
     eae:	75 13                	jne    ec3 <strtok+0x43>
     eb0:	eb 2e                	jmp    ee0 <strtok+0x60>
     ...
     ec1:	74 1d                	je     ee0 <strtok+0x60>
            if (*last_token == *d) {
     ec3:	38 c8                	cmp    %cl,%al
     ec5:	75 f1                	jne    eb8 <strtok+0x38>
        }
        if (delim_found) {
            *last_token = '\0';
    ...
    return NULL;
     ...
     ed2:	5f                   	pop    %edi
            last_token++;
     ed3:	a3 84 1b 00 00       	mov    %eax,0x1b84
}
     ed8:	5d                   	pop    %ebp
     ed9:	c3                   	ret    
     eda:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        last_token++;
     ee0:	83 45 08 01          	addl   $0x1,0x8(%ebp)
    while (*last_token != '\0') {
     ee4:	8b 45 08             	mov    0x8(%ebp),%eax
     ee7:	0f b6 08             	movzbl (%eax),%ecx
     eea:	84 c9                	test   %cl,%cl
     eec:	75 ba                	jne    ea8 <strtok+0x28>
     eee:	8b 45 08             	mov    0x8(%ebp),%eax
     ef1:	a3 84 1b 00 00       	mov    %eax,0x1b84
}
     ef6:	5b                   	pop    %ebx
    return NULL;
     ...
     efc:	c3                   	ret    
    while (*last_token != '\0') {
     efd:	a1 84 1b 00 00       	mov    0x1b84,%eax
     f02:	89 45 08             	mov    %eax,0x8(%ebp)
     f05:	eb 91                	jmp    e98 <strtok+0x18>
...
SYSCALL(fork)
     f07:	b8 01 00 00 00       	mov    $0x1,%eax
     f0c:	cd 40                	int    $0x40
     f0e:	c3                   	ret    

00000f0f <exit>:
SYSCALL(exit)
     f0f:	b8 02 00 00 00       	mov    $0x2,%eax
     f14:	cd 40                	int    $0x40
     f16:	c3                   	ret    

00000f17 <wait>:
SYSCALL(wait)
     f17:	b8 03 00 00 00       	mov    $0x3,%eax
     f1c:	cd 40                	int    $0x40
     f1e:	c3                   	ret    

00000f1f <pipe>:
SYSCALL(pipe)
     f1f:	b8 04 00 00 00       	mov    $0x4,%eax
     f24:	cd 40                	int    $0x40
     f26:	c3                   	ret    

00000f27 <read>:
SYSCALL(read)
     f27:	b8 05 00 00 00       	mov    $0x5,%eax
     f2c:	cd 40                	int    $0x40
     f2e:	c3                   	ret    

00000f2f <write>:
SYSCALL(write)
     f2f:	b8 10 00 00 00       	mov    $0x10,%eax
     f34:	cd 40                	int    $0x40
     f36:	c3                   	ret    

00000f37 <close>:
SYSCALL(close)
     f37:	b8 15 00 00 00       	mov    $0x15,%eax
     f3c:	cd 40                	int    $0x40
     f3e:	c3                   	ret    

00000f3f <kill>:
SYSCALL(kill)
     f3f:	b8 06 00 00 00       	mov    $0x6,%eax
     f44:	cd 40                	int    $0x40
     f46:	c3                   	ret    

00000f47 <exec>:
SYSCALL(exec)
     f47:	b8 07 00 00 00       	mov    $0x7,%eax
     f4c:	cd 40                	int    $0x40
     f4e:	c3                   	ret    

00000f4f <open>:
SYSCALL(open)
     f4f:	b8 0f 00 00 00       	mov    $0xf,%eax
     f54:	cd 40                	int    $0x40
     f56:	c3                   	ret    

00000f57 <mknod>:
SYSCALL(mknod)
     f57:	b8 11 00 00 00       	mov    $0x11,%eax
     f5c:	cd 40                	int    $0x40
     f5e:	c3                   	ret    

00000f5f <unlink>:
SYSCALL(unlink)
     f5f:	b8 12 00 00 00       	mov    $0x12,%eax
     f64:	cd 40                	int    $0x40
     f66:	c3                   	ret    

00000f67 <fstat>:
SYSCALL(fstat)
     f67:	b8 08 00 00 00       	mov    $0x8,%eax
     f6c:	cd 40                	int    $0x40
     f6e:	c3                   	ret    

00000f6f <link>:
SYSCALL(link)
     f6f:	b8 13 00 00 00       	mov    $0x13,%eax
     f74:	cd 40                	int    $0x40
     f76:	c3                   	ret    

00000f77 <mkdir>:
SYSCALL(mkdir)
     f77:	b8 14 00 00 00       	mov    $0x14,%eax
     f7c:	cd 40                	int    $0x40
     f7e:	c3                   	ret    

00000f7f <chdir>:
SYSCALL(chdir)
     f7f:	b8 09 00 00 00       	mov    $0x9,%eax
     f84:	cd 40                	int    $0x40
     f86:	c3                   	ret    

00000f87 <dup>:
SYSCALL(dup)
     f87:	b8 0a 00 00 00       	mov    $0xa,%eax
     f8c:	cd 40                	int    $0x40
     f8e:	c3                   	ret    

00000f8f <getpid>:
SYSCALL(getpid)
     f8f:	b8 0b 00 00 00       	mov    $0xb,%eax
     f94:	cd 40                	int    $0x40
     f96:	c3                   	ret    

00000f97 <sbrk>:
SYSCALL(sbrk)
     f97:	b8 0c 00 00 00       	mov    $0xc,%eax
     f9c:	cd 40                	int    $0x40
     f9e:	c3                   	ret    

00000f9f <sleep>:
SYSCALL(sleep)
     f9f:	b8 0d 00 00 00       	mov    $0xd,%eax
     fa4:	cd 40                	int    $0x40
     fa6:	c3                   	ret    

00000fa7 <uptime>:
SYSCALL(uptime)
     fa7:	b8 0e 00 00 00       	mov    $0xe,%eax
     fac:	cd 40                	int    $0x40
     fae:	c3                   	ret    
     faf:	90                   	nop
     ...
     fbc:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     fe9:	0f b6 92 d0 14 00 00 	movzbl 0x14d0(%edx),%edx
  ...
  write(fd, &c, 1);
    ...
    102e:	56                   	push   %esi
    102f:	57                   	push   %edi
    1030:	e8 fa fe ff ff       	call   f2f <write>
  while(--i >= 0)
    ...
    1069:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    10a5:	57                   	push   %edi
    10a6:	56                   	push   %esi
    10a7:	e8 83 fe ff ff       	call   f2f <write>
  ...
  for(i = 0; fmt[i]; i++){
    ...
    10d9:	ff 24 85 78 14 00 00 	jmp    *0x1478(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    10fe:	e8 2c fe ff ff       	call   f2f <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    110f:	57                   	push   %edi
    1110:	56                   	push   %esi
    1111:	e8 19 fe ff ff       	call   f2f <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    117b:	57                   	push   %edi
    117c:	56                   	push   %esi
    117d:	e8 ad fd ff ff       	call   f2f <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    11bf:	e8 6b fd ff ff       	call   f2f <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    11e7:	90                   	nop
          s = "(null)";
    11e8:	ba 70 14 00 00       	mov    $0x1470,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1201:	a1 88 1b 00 00       	mov    0x1b88,%eax
{
  ...
  freep = p;
    ...
    1241:	5b                   	pop    %ebx
  freep = p;
    1242:	89 15 88 1b 00 00    	mov    %edx,0x1b88
}
    1248:	5e                   	pop    %esi
    1249:	5f                   	pop    %edi
    124a:	5d                   	pop    %ebp
  ...
  freep = p;
    127c:	89 15 88 1b 00 00    	mov    %edx,0x1b88
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    129c:	8b 3d 88 1b 00 00    	mov    0x1b88,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    12e1:	8b 3d 88 1b 00 00    	mov    0x1b88,%edi
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12f3:	e8 9f fc ff ff       	call   f97 <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    130f:	8b 15 88 1b 00 00    	mov    0x1b88,%edx
    ...
    133c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    133f:	89 15 88 1b 00 00    	mov    %edx,0x1b88
}
    ...
    134f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1350:	c7 05 88 1b 00 00 8c 	movl   $0x1b8c,0x1b88
    1357:	1b 00 00 
    base.s.size = 0;
    135a:	bf 8c 1b 00 00       	mov    $0x1b8c,%edi
    base.s.ptr = freep = prevp = &base;
    135f:	c7 05 8c 1b 00 00 8c 	movl   $0x1b8c,0x1b8c
    1366:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1369:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    136b:	c7 05 90 1b 00 00 00 	movl   $0x0,0x1b90
    1372:	00 00 00 
    if(p->s.size >= nunits){

...
main(int argc, char **argv)
{
  ...
  39:	e8 91 03 00 00       	call   3cf <kill>
  for(i=1; i<argc; i++)
  3e:	83 c4 10             	add    $0x10,%esp
  41:	39 de                	cmp    %ebx,%esi
  43:	75 e3                	jne    28 <main+0x28>
  exit();
  45:	e8 55 03 00 00       	call   39f <exit>
    printf(2, "usage: kill pid...\n");
  4a:	50                   	push   %eax
  4b:	50                   	push   %eax
  ...
  53:	e8 98 04 00 00       	call   4f0 <printf>
    exit();
  58:	e8 42 03 00 00       	call   39f <exit>
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
...
char *strtok(char *str, const char *delim) {
 ...
 323:	a3 ac 0b 00 00       	mov    %eax,0xbac
    }
 ...
 362:	5f                   	pop    %edi
            last_token++;
 363:	a3 ac 0b 00 00       	mov    %eax,0xbac
}
 368:	5d                   	pop    %ebp
 369:	c3                   	ret    
 ...
 381:	a3 ac 0b 00 00       	mov    %eax,0xbac
}
 386:	5b                   	pop    %ebx
    return NULL;
 ...
 38c:	c3                   	ret    
    while (*last_token != '\0') {
 38d:	a1 ac 0b 00 00       	mov    0xbac,%eax
...
free(void *ap)
{
 ...
 691:	a1 b0 0b 00 00       	mov    0xbb0,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 b0 0b 00 00    	mov    %edx,0xbb0
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 b0 0b 00 00    	mov    %edx,0xbb0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d b0 0b 00 00    	mov    0xbb0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d b0 0b 00 00    	mov    0xbb0,%edi
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 b0 0b 00 00    	mov    0xbb0,%edx
 ...
 7cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 b0 0b 00 00    	mov    %edx,0xbb0
}
 ...
 7df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 b0 0b 00 00 b4 	movl   $0xbb4,0xbb0
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	bf b4 0b 00 00       	mov    $0xbb4,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 b4 0b 00 00 b4 	movl   $0xbb4,0xbb4
 7f6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 b8 0b 00 00 00 	movl   $0x0,0xbb8
 802:	00 00 00 
    if(p->s.size >= nunits){

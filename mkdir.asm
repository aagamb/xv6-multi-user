...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 ed 03 00 00       	call   427 <mkdir>
  ...
  exit();
  4b:	e8 6f 03 00 00       	call   3bf <exit>
      printf(2, "mkdir: %s failed to create\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	push   (%ebx)
  ...
  6d:	e8 9e 04 00 00       	call   510 <printf>
    exit();
  72:	e8 48 03 00 00       	call   3bf <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
...
char *strtok(char *str, const char *delim) {
 ...
 343:	a3 ec 0b 00 00       	mov    %eax,0xbec
    }
 ...
 382:	5f                   	pop    %edi
            last_token++;
 383:	a3 ec 0b 00 00       	mov    %eax,0xbec
}
 388:	5d                   	pop    %ebp
 389:	c3                   	ret    
 ...
 3a1:	a3 ec 0b 00 00       	mov    %eax,0xbec
}
 3a6:	5b                   	pop    %ebx
    return NULL;
 ...
 3ac:	c3                   	ret    
    while (*last_token != '\0') {
 3ad:	a1 ec 0b 00 00       	mov    0xbec,%eax
 ...
 519:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 697:	90                   	nop
          s = "(null)";
 698:	ba 6b 08 00 00       	mov    $0x86b,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b1:	a1 f0 0b 00 00       	mov    0xbf0,%eax
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	89 15 f0 0b 00 00    	mov    %edx,0xbf0
}
 6f8:	5e                   	pop    %esi
 6f9:	5f                   	pop    %edi
 6fa:	5d                   	pop    %ebp
 ...
 729:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 72c:	89 15 f0 0b 00 00    	mov    %edx,0xbf0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 3d f0 0b 00 00    	mov    0xbf0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 4f                	jae    7e0 <malloc+0xa0>
    ...
    if(p == freep)
 791:	8b 3d f0 0b 00 00    	mov    0xbf0,%edi
 ...
 7ba:	e8 f1 fe ff ff       	call   6b0 <free>
  return freep;
 7bf:	8b 15 f0 0b 00 00    	mov    0xbf0,%edx
 ...
 7ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7ef:	89 15 f0 0b 00 00    	mov    %edx,0xbf0
}
 ...
 7ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 f0 0b 00 00 f4 	movl   $0xbf4,0xbf0
 807:	0b 00 00 
    base.s.size = 0;
 80a:	bf f4 0b 00 00       	mov    $0xbf4,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 f4 0b 00 00 f4 	movl   $0xbf4,0xbf4
 816:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 81b:	c7 05 f8 0b 00 00 00 	movl   $0x0,0xbf8
 822:	00 00 00 
    if(p->s.size >= nunits){

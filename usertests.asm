...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 d4 39 00 00       	call   39ff <open>
    ...
    exit();
      40:	e8 7a 39 00 00       	call   39bf <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 a9 39 00 00       	call   39ff <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 89 39 00 00       	call   39e7 <close>
  ...
  exit();
     10d:	e8 ad 38 00 00       	call   39bf <exit>
...
00000120 <iputtest>:
{
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 d9 38 00 00       	call   3a2f <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 a1 38 00 00       	call   3a0f <unlink>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 ad 38 00 00       	call   3a2f <chdir>
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 90 5f 00 00    	push   0x5f90
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 90 5f 00 00    	push   0x5f90
     1ae:	e8 5d 39 00 00       	call   3b10 <printf>
    exit();
     1b3:	e8 07 38 00 00       	call   39bf <exit>
    printf(stdout, "chdir / failed\n");
     1b8:	50                   	push   %eax
     1b9:	50                   	push   %eax
     1ba:	68 83 3e 00 00       	push   $0x3e83
     1bf:	ff 35 90 5f 00 00    	push   0x5f90
     1c5:	e8 46 39 00 00       	call   3b10 <printf>
    exit();
     1ca:	e8 f0 37 00 00       	call   39bf <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1cf:	52                   	push   %edx
     1d0:	52                   	push   %edx
     1d1:	68 67 3e 00 00       	push   $0x3e67
     1d6:	ff 35 90 5f 00 00    	push   0x5f90
     1dc:	e8 2f 39 00 00       	call   3b10 <printf>
    exit();
     1e1:	e8 d9 37 00 00       	call   39bf <exit>
    printf(stdout, "chdir iputdir failed\n");
     1e6:	51                   	push   %ecx
     1e7:	51                   	push   %ecx
     1e8:	68 46 3e 00 00       	push   $0x3e46
     1ed:	ff 35 90 5f 00 00    	push   0x5f90
     1f3:	e8 18 39 00 00       	call   3b10 <printf>
    exit();
     1f8:	e8 c2 37 00 00       	call   39bf <exit>
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 90 5f 00 00    	push   0x5f90
     211:	e8 fa 38 00 00       	call   3b10 <printf>
  pid = fork();
     216:	e8 9c 37 00 00       	call   39b7 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 f2 37 00 00       	call   3a27 <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 e2 37 00 00       	call   3a2f <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     260:	e8 aa 37 00 00       	call   3a0f <unlink>
     265:	83 c4 10             	add    $0x10,%esp
     268:	85 c0                	test   %eax,%eax
     26a:	78 2c                	js     298 <exitiputtest+0x98>
    exit();
     26c:	e8 4e 37 00 00       	call   39bf <exit>
     271:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  wait();
     278:	e8 4a 37 00 00       	call   39c7 <wait>
  printf(stdout, "exitiput test ok\n");
     27d:	83 ec 08             	sub    $0x8,%esp
     280:	68 b6 3e 00 00       	push   $0x3eb6
     285:	ff 35 90 5f 00 00    	push   0x5f90
     ...
     2a0:	ff 35 90 5f 00 00    	push   0x5f90
     2a6:	e8 65 38 00 00       	call   3b10 <printf>
      exit();
     2ab:	e8 0f 37 00 00       	call   39bf <exit>
    printf(stdout, "fork failed\n");
     2b0:	51                   	push   %ecx
     2b1:	51                   	push   %ecx
     2b2:	68 79 4d 00 00       	push   $0x4d79
     2b7:	ff 35 90 5f 00 00    	push   0x5f90
     2bd:	e8 4e 38 00 00       	call   3b10 <printf>
    exit();
     2c2:	e8 f8 36 00 00       	call   39bf <exit>
      printf(stdout, "mkdir failed\n");
     2c7:	52                   	push   %edx
     2c8:	52                   	push   %edx
     2c9:	68 38 3e 00 00       	push   $0x3e38
     2ce:	ff 35 90 5f 00 00    	push   0x5f90
     2d4:	e8 37 38 00 00       	call   3b10 <printf>
      exit();
     2d9:	e8 e1 36 00 00       	call   39bf <exit>
      printf(stdout, "child chdir failed\n");
     2de:	50                   	push   %eax
     2df:	50                   	push   %eax
     2e0:	68 a2 3e 00 00       	push   $0x3ea2
     2e5:	ff 35 90 5f 00 00    	push   0x5f90
     2eb:	e8 20 38 00 00       	call   3b10 <printf>
      exit();
     2f0:	e8 ca 36 00 00       	call   39bf <exit>
...
00000300 <openiputtest>:
{
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     342:	e8 b8 36 00 00       	call   39ff <open>
    if(fd >= 0){
  ...
  printf(stdout, "openiput test ok\n");
    ...
    exit();
     3b0:	e8 0a 36 00 00       	call   39bf <exit>
    printf(stdout, "fork failed\n");
     3b5:	52                   	push   %edx
     3b6:	52                   	push   %edx
     3b7:	68 79 4d 00 00       	push   $0x4d79
     3bc:	ff 35 90 5f 00 00    	push   0x5f90
     3c2:	e8 49 37 00 00       	call   3b10 <printf>
    exit();
     3c7:	e8 f3 35 00 00       	call   39bf <exit>
    printf(stdout, "mkdir oidir failed\n");
     3cc:	51                   	push   %ecx
     3cd:	51                   	push   %ecx
     3ce:	68 dd 3e 00 00       	push   $0x3edd
     3d3:	ff 35 90 5f 00 00    	push   0x5f90
     3d9:	e8 32 37 00 00       	call   3b10 <printf>
    exit();
     3de:	e8 dc 35 00 00       	call   39bf <exit>
    printf(stdout, "unlink failed\n");
     3e3:	50                   	push   %eax
     3e4:	50                   	push   %eax
     3e5:	68 f1 3e 00 00       	push   $0x3ef1
     3ea:	ff 35 90 5f 00 00    	push   0x5f90
     3f0:	e8 1b 37 00 00       	call   3b10 <printf>
    exit();
     3f5:	e8 c5 35 00 00       	call   39bf <exit>
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 90 5f 00 00    	push   0x5f90
  ...
  fd = open("echo", 0);
     ...
     41f:	e8 db 35 00 00       	call   39ff <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     42e:	50                   	push   %eax
     42f:	e8 b3 35 00 00       	call   39e7 <close>
  fd = open("doesnotexist", 0);
     434:	5a                   	pop    %edx
     435:	59                   	pop    %ecx
     436:	6a 00                	push   $0x0
     438:	68 35 3f 00 00       	push   $0x3f35
     43d:	e8 bd 35 00 00       	call   39ff <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 90 5f 00 00    	push   0x5f90
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 90 5f 00 00    	push   0x5f90
     46e:	e8 9d 36 00 00       	call   3b10 <printf>
    exit();
     473:	e8 47 35 00 00       	call   39bf <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     478:	50                   	push   %eax
     479:	50                   	push   %eax
     47a:	68 42 3f 00 00       	push   $0x3f42
     47f:	ff 35 90 5f 00 00    	push   0x5f90
     485:	e8 86 36 00 00       	call   3b10 <printf>
    exit();
     48a:	e8 30 35 00 00       	call   39bf <exit>
     48f:	90                   	nop
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 90 5f 00 00    	push   0x5f90
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4b4:	e8 46 35 00 00       	call   39ff <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 90 5f 00 00    	push   0x5f90
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4ea:	56                   	push   %esi
     4eb:	e8 ef 34 00 00       	call   39df <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     506:	56                   	push   %esi
     507:	e8 d3 34 00 00       	call   39df <write>
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 90 5f 00 00    	push   0x5f90
     52e:	e8 dd 35 00 00       	call   3b10 <printf>
  close(fd);
     533:	89 34 24             	mov    %esi,(%esp)
     536:	e8 ac 34 00 00       	call   39e7 <close>
  fd = open("small", O_RDONLY);
     53b:	5b                   	pop    %ebx
     53c:	5e                   	pop    %esi
     53d:	6a 00                	push   $0x0
     53f:	68 7f 3f 00 00       	push   $0x3f7f
     544:	e8 b6 34 00 00       	call   39ff <open>
  if(fd >= 0){
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     55e:	ff 35 90 5f 00 00    	push   0x5f90
     564:	e8 a7 35 00 00       	call   3b10 <printf>
  i = read(fd, buf, 2000);
     569:	83 c4 0c             	add    $0xc,%esp
     56c:	68 d0 07 00 00       	push   $0x7d0
     571:	68 e0 86 00 00       	push   $0x86e0
     576:	53                   	push   %ebx
     577:	e8 5b 34 00 00       	call   39d7 <read>
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 90 5f 00 00    	push   0x5f90
     598:	e8 73 35 00 00       	call   3b10 <printf>
  close(fd);
     59d:	89 1c 24             	mov    %ebx,(%esp)
     5a0:	e8 42 34 00 00       	call   39e7 <close>
  if(unlink("small") < 0){
     5a5:	c7 04 24 7f 3f 00 00 	movl   $0x3f7f,(%esp)
     5ac:	e8 5e 34 00 00       	call   3a0f <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 90 5f 00 00    	push   0x5f90
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 90 5f 00 00    	push   0x5f90
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     694:	e8 66 33 00 00       	call   39ff <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6c3:	56                   	push   %esi
     6c4:	e8 16 33 00 00       	call   39df <write>
  ...
  close(fd);
     ...
     6e5:	56                   	push   %esi
     6e6:	e8 fc 32 00 00       	call   39e7 <close>
  fd = open("big", O_RDONLY);
     6eb:	5b                   	pop    %ebx
     6ec:	5e                   	pop    %esi
     6ed:	6a 00                	push   $0x0
     6ef:	68 c7 40 00 00       	push   $0x40c7
     6f4:	e8 06 33 00 00       	call   39ff <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     734:	53                   	push   %ebx
     735:	e8 9d 32 00 00       	call   39d7 <read>
    if(i == 0){
  ...
  close(fd);
     ...
     750:	53                   	push   %ebx
     751:	e8 91 32 00 00       	call   39e7 <close>
  if(unlink("big") < 0){
     756:	c7 04 24 c7 40 00 00 	movl   $0x40c7,(%esp)
     75d:	e8 ad 32 00 00       	call   3a0f <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 90 5f 00 00    	push   0x5f90
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 90 5f 00 00    	push   0x5f90
     857:	e8 b4 32 00 00       	call   3b10 <printf>
  name[0] = 'a';
     85c:	c6 05 d0 86 00 00 61 	movb   $0x61,0x86d0
  name[2] = '\0';
     863:	83 c4 10             	add    $0x10,%esp
     866:	c6 05 d2 86 00 00 00 	movb   $0x0,0x86d2
  for(i = 0; i < 52; i++){
     86d:	8d 76 00             	lea    0x0(%esi),%esi
    fd = open(name, O_CREATE|O_RDWR);
     870:	83 ec 08             	sub    $0x8,%esp
    name[1] = '0' + i;
     873:	88 1d d1 86 00 00    	mov    %bl,0x86d1
  for(i = 0; i < 52; i++){
     879:	83 c3 01             	add    $0x1,%ebx
    fd = open(name, O_CREATE|O_RDWR);
     87c:	68 02 02 00 00       	push   $0x202
     881:	68 d0 86 00 00       	push   $0x86d0
     886:	e8 74 31 00 00       	call   39ff <open>
    close(fd);
     88b:	89 04 24             	mov    %eax,(%esp)
     88e:	e8 54 31 00 00       	call   39e7 <close>
  for(i = 0; i < 52; i++){
     893:	83 c4 10             	add    $0x10,%esp
     896:	80 fb 64             	cmp    $0x64,%bl
     899:	75 d5                	jne    870 <createtest+0x30>
  name[0] = 'a';
     89b:	c6 05 d0 86 00 00 61 	movb   $0x61,0x86d0
  name[2] = '\0';
     8a2:	bb 30 00 00 00       	mov    $0x30,%ebx
     8a7:	c6 05 d2 86 00 00 00 	movb   $0x0,0x86d2
  for(i = 0; i < 52; i++){
     8ae:	66 90                	xchg   %ax,%ax
    unlink(name);
     8b0:	83 ec 0c             	sub    $0xc,%esp
    name[1] = '0' + i;
     8b3:	88 1d d1 86 00 00    	mov    %bl,0x86d1
  for(i = 0; i < 52; i++){
     8b9:	83 c3 01             	add    $0x1,%ebx
    unlink(name);
     8bc:	68 d0 86 00 00       	push   $0x86d0
     8c1:	e8 49 31 00 00       	call   3a0f <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 90 5f 00 00    	push   0x5f90
...
000008f0 <dirtest>:
{
  ...
  if(chdir("dir0") < 0){
     ...
     921:	e8 09 31 00 00       	call   3a2f <chdir>
  ...
  if(chdir("..") < 0){
     ...
     939:	e8 f1 30 00 00       	call   3a2f <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     94d:	e8 bd 30 00 00       	call   3a0f <unlink>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 90 5f 00 00    	push   0x5f90
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 90 5f 00 00    	push   0x5f90
     97e:	e8 8d 31 00 00       	call   3b10 <printf>
    exit();
     983:	e8 37 30 00 00       	call   39bf <exit>
    printf(stdout, "unlink dir0 failed\n");
     988:	50                   	push   %eax
     989:	50                   	push   %eax
     98a:	68 31 41 00 00       	push   $0x4131
     98f:	ff 35 90 5f 00 00    	push   0x5f90
     995:	e8 76 31 00 00       	call   3b10 <printf>
    exit();
     99a:	e8 20 30 00 00       	call   39bf <exit>
    printf(stdout, "chdir .. failed\n");
     99f:	52                   	push   %edx
     9a0:	52                   	push   %edx
     9a1:	68 20 41 00 00       	push   $0x4120
     9a6:	ff 35 90 5f 00 00    	push   0x5f90
     9ac:	e8 5f 31 00 00       	call   3b10 <printf>
    exit();
     9b1:	e8 09 30 00 00       	call   39bf <exit>
    printf(stdout, "chdir dir0 failed\n");
     9b6:	51                   	push   %ecx
     9b7:	51                   	push   %ecx
     9b8:	68 0d 41 00 00       	push   $0x410d
     9bd:	ff 35 90 5f 00 00    	push   0x5f90
     9c3:	e8 48 31 00 00       	call   3b10 <printf>
    exit();
     9c8:	e8 f2 2f 00 00       	call   39bf <exit>
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 90 5f 00 00    	push   0x5f90
     9e1:	e8 2a 31 00 00       	call   3b10 <printf>
  if(exec("echo", echoargv) < 0){
     9e6:	5a                   	pop    %edx
     9e7:	59                   	pop    %ecx
     9e8:	68 94 5f 00 00       	push   $0x5f94
     9ed:	68 1d 3f 00 00       	push   $0x3f1d
     9f2:	e8 00 30 00 00       	call   39f7 <exec>
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 90 5f 00 00    	push   0x5f90
     a0d:	e8 fe 30 00 00       	call   3b10 <printf>
    exit();
     a12:	e8 a8 2f 00 00       	call   39bf <exit>
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    close(fds[1]);
     a5d:	e8 85 2f 00 00       	call   39e7 <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a6f:	56                   	push   %esi
     a70:	68 e0 86 00 00       	push   $0x86e0
     a75:	ff 75 e0             	push   -0x20(%ebp)
     a78:	e8 5a 2f 00 00       	call   39d7 <read>
     ...
     a95:	38 90 e0 86 00 00    	cmp    %dl,0x86e0(%eax)
  ...
  seq = 0;
    ...
    close(fds[0]);
     ad7:	e8 0b 2f 00 00       	call   39e7 <close>
     ...
     aeb:	83 c0 01             	add    $0x1,%eax
        buf[i] = seq++;
     aee:	88 90 df 86 00 00    	mov    %dl,0x86df(%eax)
      for(i = 0; i < 1033; i++)
     ...
     b09:	68 e0 86 00 00       	push   $0x86e0
     b0e:	ff 75 e4             	push   -0x1c(%ebp)
     b11:	e8 c9 2e 00 00       	call   39df <write>
    ...
    exit();
     b28:	e8 92 2e 00 00       	call   39bf <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b3c:	e8 a6 2e 00 00       	call   39e7 <close>
    wait();
     b41:	e8 81 2e 00 00       	call   39c7 <wait>
  printf(1, "pipe1 ok\n");
     b46:	5a                   	pop    %edx
     b47:	59                   	pop    %ecx
     ...
     b67:	e8 a4 2f 00 00       	call   3b10 <printf>
      exit();
     b6c:	e8 4e 2e 00 00       	call   39bf <exit>
    ...
    exit();
     b7f:	e8 3b 2e 00 00       	call   39bf <exit>
    ...
    exit();
     b92:	e8 28 2e 00 00       	call   39bf <exit>
     ...
     ba0:	e8 6b 2f 00 00       	call   3b10 <printf>
        exit();
     ba5:	e8 15 2e 00 00       	call   39bf <exit>
...
00000bb0 <preempt>:
{
  ...
  pid1 = fork();
     bc5:	e8 ed 2d 00 00       	call   39b7 <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bda:	e8 d8 2d 00 00       	call   39b7 <fork>
  ...
  pipe(pfds);
     ...
     bf6:	50                   	push   %eax
     bf7:	e8 d3 2d 00 00       	call   39cf <pipe>
  pid3 = fork();
     bfc:	e8 b6 2d 00 00       	call   39b7 <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[1]);
     ...
     c39:	e8 a9 2d 00 00       	call   39e7 <close>
  ...
  close(pfds[1]);
     ...
     c4e:	e8 94 2d 00 00       	call   39e7 <close>
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     c53:	83 c4 0c             	add    $0xc,%esp
     c56:	68 00 20 00 00       	push   $0x2000
     c5b:	68 e0 86 00 00       	push   $0x86e0
     c60:	ff 75 e0             	push   -0x20(%ebp)
     c63:	e8 6f 2d 00 00       	call   39d7 <read>
  ...
  close(pfds[0]);
     ...
     c76:	e8 6c 2d 00 00       	call   39e7 <close>
  printf(1, "kill... ");
     c7b:	58                   	pop    %eax
     c7c:	5a                   	pop    %edx
  ...
  kill(pid1);
     ...
     c8c:	e8 5e 2d 00 00       	call   39ef <kill>
  kill(pid2);
     c91:	89 34 24             	mov    %esi,(%esp)
     c94:	e8 56 2d 00 00       	call   39ef <kill>
  kill(pid3);
     c99:	89 3c 24             	mov    %edi,(%esp)
     c9c:	e8 4e 2d 00 00       	call   39ef <kill>
  printf(1, "wait... ");
     ca1:	59                   	pop    %ecx
     ca2:	5b                   	pop    %ebx
  ...
  wait();
     caf:	e8 13 2d 00 00       	call   39c7 <wait>
  wait();
     cb4:	e8 0e 2d 00 00       	call   39c7 <wait>
  wait();
     cb9:	e8 09 2d 00 00       	call   39c7 <wait>
  printf(1, "preempt ok\n");
     cbe:	5e                   	pop    %esi
     cbf:	5f                   	pop    %edi
...
00000d10 <exitwait>:
{
    ...
    if(pid){
     d20:	74 68                	je     d8a <exitwait+0x7a>
      if(wait() != pid){
     d22:	e8 a0 2c 00 00       	call   39c7 <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d30:	e8 82 2c 00 00       	call   39b7 <fork>
  ...
  printf(1, "exitwait ok\n");
     ...
     d89:	c3                   	ret    
      exit();
     d8a:	e8 30 2c 00 00       	call   39bf <exit>
     d8f:	90                   	nop
...
00000d90 <mem>:
{
  ...
  ppid = getpid();
     da6:	e8 94 2c 00 00       	call   3a3f <getpid>
     dab:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     dad:	e8 05 2c 00 00       	call   39b7 <fork>
    ...
    exit();
     e1f:	e8 9b 2b 00 00       	call   39bf <exit>
     ...
     e3a:	e8 b0 2b 00 00       	call   39ef <kill>
      exit();
     e3f:	e8 7b 2b 00 00       	call   39bf <exit>
     ...
     e4d:	5d                   	pop    %ebp
    wait();
     e4e:	e9 74 2b 00 00       	jmp    39c7 <wait>
...
00000e60 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e7c:	e8 8e 2b 00 00       	call   3a0f <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e81:	5b                   	pop    %ebx
     e82:	5e                   	pop    %esi
     e83:	68 02 02 00 00       	push   $0x202
     e88:	68 73 42 00 00       	push   $0x4273
     e8d:	e8 6d 2b 00 00       	call   39ff <open>
  if(fd < 0){
  ...
  pid = fork();
     ea7:	e8 0b 2b 00 00       	call   39b7 <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     eda:	56                   	push   %esi
     edb:	57                   	push   %edi
     edc:	e8 fe 2a 00 00       	call   39df <write>
  ...
  if(pid == 0)
    ...
    wait();
     f06:	e8 bc 2a 00 00       	call   39c7 <wait>
  close(fd);
  ...
  close(fd);
     ...
     f14:	e8 ce 2a 00 00       	call   39e7 <close>
  fd = open("sharedfd", 0);
     f19:	58                   	pop    %eax
     f1a:	5a                   	pop    %edx
     f1b:	6a 00                	push   $0x0
     f1d:	68 73 42 00 00       	push   $0x4273
     f22:	e8 d8 2a 00 00       	call   39ff <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	e8 86 2a 00 00       	call   39d7 <read>
  ...
  close(fd);
     ...
     f86:	e8 5c 2a 00 00       	call   39e7 <close>
  unlink("sharedfd");
     f8b:	c7 04 24 73 42 00 00 	movl   $0x4273,(%esp)
     f92:	e8 78 2a 00 00       	call   3a0f <unlink>
  if(nc == 10000 && np == 10000){
    ...
    return;
     ...
     ffa:	c3                   	ret    
    exit();
     ffb:	e8 bf 29 00 00       	call   39bf <exit>
    ...
    exit();
    100e:	e8 ac 29 00 00       	call   39bf <exit>
    ...
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    105e:	56                   	push   %esi
    105f:	e8 ab 29 00 00       	call   3a0f <unlink>
    pid = fork();
    1064:	e8 4e 29 00 00       	call   39b7 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1088:	e8 3a 29 00 00       	call   39c7 <wait>
  for(i = 0; i < 2; i++){
    108d:	31 f6                	xor    %esi,%esi
    wait();
    108f:	e8 33 29 00 00       	call   39c7 <wait>
    1094:	e8 2e 29 00 00       	call   39c7 <wait>
    1099:	e8 29 29 00 00       	call   39c7 <wait>
    fname = names[i];
    ...
    fd = open(fname, 0);
    10ad:	e8 4d 29 00 00       	call   39ff <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10c8:	68 e0 86 00 00       	push   $0x86e0
    10cd:	ff 75 d4             	push   -0x2c(%ebp)
    10d0:	e8 02 29 00 00       	call   39d7 <read>
    ...
    10e3:	0f be 88 e0 86 00 00 	movsbl 0x86e0(%eax),%ecx
    ...
    1104:	e8 de 28 00 00       	call   39e7 <close>
    if(total != 12*500){
    ...
    111e:	e8 ec 28 00 00       	call   3a0f <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1159:	e8 b2 29 00 00       	call   3b10 <printf>
          exit();
    115e:	e8 5c 28 00 00       	call   39bf <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1163:	83 ec 08             	sub    $0x8,%esp
    1166:	68 02 02 00 00       	push   $0x202
    116b:	56                   	push   %esi
    116c:	e8 8e 28 00 00       	call   39ff <open>
      if(fd < 0){
    ...
    118b:	68 e0 86 00 00       	push   $0x86e0
    ...
    11a0:	68 e0 86 00 00       	push   $0x86e0
    11a5:	56                   	push   %esi
    11a6:	e8 34 28 00 00       	call   39df <write>
    ...
    11b8:	75 de                	jne    1198 <fourfiles+0x178>
      exit();
    11ba:	e8 00 28 00 00       	call   39bf <exit>
    ...
    11c8:	e8 43 29 00 00       	call   3b10 <printf>
        exit();
    11cd:	e8 ed 27 00 00       	call   39bf <exit>
    ...
    11e2:	e8 29 29 00 00       	call   3b10 <printf>
      exit();
    11e7:	e8 d3 27 00 00       	call   39bf <exit>
    ...
    11f5:	e8 16 29 00 00       	call   3b10 <printf>
      exit();
    11fa:	e8 c0 27 00 00       	call   39bf <exit>
    ...
    1208:	e8 03 29 00 00       	call   3b10 <printf>
          exit();
    120d:	e8 ad 27 00 00       	call   39bf <exit>
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    123a:	e8 78 27 00 00       	call   39b7 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1255:	e8 6d 27 00 00       	call   39c7 <wait>
  for(i = 0; i < N; i++){
    125a:	31 f6                	xor    %esi,%esi
    125c:	8d 7d c8             	lea    -0x38(%ebp),%edi
    wait();
    125f:	e8 63 27 00 00       	call   39c7 <wait>
    1264:	e8 5e 27 00 00       	call   39c7 <wait>
    1269:	e8 59 27 00 00       	call   39c7 <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    12a6:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    12a9:	e8 51 27 00 00       	call   39ff <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12cc:	50                   	push   %eax
    12cd:	e8 15 27 00 00       	call   39e7 <close>
  ...
  for(i = 0; i < N; i++){
    ...
    1308:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    130b:	e8 ff 26 00 00       	call   3a0f <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    134d:	e8 be 27 00 00       	call   3b10 <printf>
        exit();
    1352:	e8 68 26 00 00       	call   39bf <exit>
    ...
    1397:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    139a:	e8 60 26 00 00       	call   39ff <open>
        if(fd < 0){
    ...
    13a9:	50                   	push   %eax
    13aa:	e8 38 26 00 00       	call   39e7 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13c6:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13c9:	e8 41 26 00 00       	call   3a0f <unlink>
    ...
    13de:	e8 2d 27 00 00       	call   3b10 <printf>
            exit();
    13e3:	e8 d7 25 00 00       	call   39bf <exit>
    13e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    13ef:	90                   	nop
      exit();
    13f0:	e8 ca 25 00 00       	call   39bf <exit>
    ...
    1400:	e8 0b 27 00 00       	call   3b10 <printf>
        exit();
    1405:	e8 b5 25 00 00       	call   39bf <exit>
      printf(1, "fork failed\n");
    ...
    1414:	e8 f7 26 00 00       	call   3b10 <printf>
      exit();
    1419:	e8 a1 25 00 00       	call   39bf <exit>
          printf(1, "create failed\n");
    ...
    1428:	e8 e3 26 00 00       	call   3b10 <printf>
          exit();
    142d:	e8 8d 25 00 00       	call   39bf <exit>
...
00001440 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1460:	e8 9a 25 00 00       	call   39ff <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    147c:	50                   	push   %eax
    147d:	e8 5d 25 00 00       	call   39df <write>
  close(fd);
    1482:	89 1c 24             	mov    %ebx,(%esp)
    1485:	e8 5d 25 00 00       	call   39e7 <close>
  fd = open("unlinkread", O_RDWR);
    148a:	58                   	pop    %eax
    148b:	5a                   	pop    %edx
    148c:	6a 02                	push   $0x2
    148e:	68 25 43 00 00       	push   $0x4325
    1493:	e8 67 25 00 00       	call   39ff <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    14ad:	e8 5d 25 00 00       	call   3a0f <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ca:	e8 30 25 00 00       	call   39ff <open>
  write(fd1, "yyy", 3);
  ...
  close(fd);
    ...
    152c:	53                   	push   %ebx
    152d:	e8 b5 24 00 00       	call   39e7 <close>
  unlink("unlinkread");
    1532:	c7 04 24 25 43 00 00 	movl   $0x4325,(%esp)
    1539:	e8 d1 24 00 00       	call   3a0f <unlink>
  printf(1, "unlinkread ok\n");
    ...
    exit();
    1564:	e8 56 24 00 00       	call   39bf <exit>
    ...
    exit();
    1577:	e8 43 24 00 00       	call   39bf <exit>
    ...
    exit();
    158a:	e8 30 24 00 00       	call   39bf <exit>
    ...
    exit();
    159d:	e8 1d 24 00 00       	call   39bf <exit>
    ...
    exit();
    15b0:	e8 0a 24 00 00       	call   39bf <exit>
    ...
    exit();
    15c3:	e8 f7 23 00 00       	call   39bf <exit>
...
000015d0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1623:	50                   	push   %eax
    1624:	e8 b6 23 00 00       	call   39df <write>
  ...
  close(fd);
    ...
    1638:	53                   	push   %ebx
    1639:	e8 a9 23 00 00       	call   39e7 <close>
  if(link("lf1", "lf2") < 0){
    163e:	5b                   	pop    %ebx
    163f:	58                   	pop    %eax
    1640:	68 ea 43 00 00       	push   $0x43ea
    1645:	68 e6 43 00 00       	push   $0x43e6
    164a:	e8 d0 23 00 00       	call   3a1f <link>
  ...
  unlink("lf1");
    ...
    1662:	e8 a8 23 00 00       	call   3a0f <unlink>
  if(open("lf1", 0) >= 0){
    1667:	58                   	pop    %eax
    1668:	5a                   	pop    %edx
    1669:	6a 00                	push   $0x0
    166b:	68 e6 43 00 00       	push   $0x43e6
    1670:	e8 8a 23 00 00       	call   39ff <open>
  ...
  fd = open("lf2", 0);
    ...
    168a:	e8 70 23 00 00       	call   39ff <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16a4:	68 e0 86 00 00       	push   $0x86e0
    16a9:	50                   	push   %eax
    16aa:	e8 28 23 00 00       	call   39d7 <read>
  ...
  close(fd);
    ...
    16be:	53                   	push   %ebx
    16bf:	e8 23 23 00 00       	call   39e7 <close>
  if(link("lf2", "lf2") >= 0){
    16c4:	58                   	pop    %eax
    16c5:	5a                   	pop    %edx
    16c6:	68 ea 43 00 00       	push   $0x43ea
    16cb:	68 ea 43 00 00       	push   $0x43ea
    16d0:	e8 4a 23 00 00       	call   3a1f <link>
  ...
  unlink("lf2");
    ...
    16e8:	e8 22 23 00 00       	call   3a0f <unlink>
  if(link("lf2", "lf1") >= 0){
    16ed:	59                   	pop    %ecx
    16ee:	5b                   	pop    %ebx
    16ef:	68 e6 43 00 00       	push   $0x43e6
    16f4:	68 ea 43 00 00       	push   $0x43ea
    16f9:	e8 21 23 00 00       	call   3a1f <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1712:	e8 08 23 00 00       	call   3a1f <link>
  ...
  printf(1, "linktest ok\n");
    ...
    exit();
    1743:	e8 77 22 00 00       	call   39bf <exit>
    ...
    exit();
    1756:	e8 64 22 00 00       	call   39bf <exit>
    ...
    exit();
    1769:	e8 51 22 00 00       	call   39bf <exit>
    ...
    exit();
    177c:	e8 3e 22 00 00       	call   39bf <exit>
    ...
    exit();
    178f:	e8 2b 22 00 00       	call   39bf <exit>
    ...
    exit();
    17a2:	e8 18 22 00 00       	call   39bf <exit>
    ...
    exit();
    17b5:	e8 05 22 00 00       	call   39bf <exit>
    ...
    exit();
    17c8:	e8 f2 21 00 00       	call   39bf <exit>
    ...
    exit();
    17db:	e8 df 21 00 00       	call   39bf <exit>
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 40; i++){
    ...
    1829:	53                   	push   %ebx
    182a:	e8 d0 21 00 00       	call   39ff <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1839:	83 c6 01             	add    $0x1,%esi
      close(fd);
    183c:	50                   	push   %eax
    183d:	e8 a5 21 00 00       	call   39e7 <close>
    1842:	83 c4 10             	add    $0x10,%esp
      wait();
    1845:	e8 7d 21 00 00       	call   39c7 <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    185d:	e8 ad 21 00 00       	call   3a0f <unlink>
    pid = fork();
    1862:	e8 50 21 00 00       	call   39b7 <fork>
    if(pid && (i % 3) == 1){
    ...
    1884:	53                   	push   %ebx
    1885:	e8 75 21 00 00       	call   39ff <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 3e 21 00 00       	call   3a1f <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 de 20 00 00       	call   39c7 <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    190e:	e8 ec 20 00 00       	call   39ff <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 ab 20 00 00       	call   39d7 <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 6e 20 00 00       	call   39e7 <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 6d 20 00 00       	call   3a0f <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 65 20 00 00       	call   3a0f <unlink>
      unlink(file);
    19aa:	89 1c 24             	mov    %ebx,(%esp)
    19ad:	e8 5d 20 00 00       	call   3a0f <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 55 20 00 00       	call   3a0f <unlink>
    19ba:	83 c4 10             	add    $0x10,%esp
    if(pid == 0)
    19bd:	85 ff                	test   %edi,%edi
    19bf:	0f 84 fc fe ff ff    	je     18c1 <concreate+0xe1>
      wait();
    19c5:	e8 fd 1f 00 00       	call   39c7 <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19dc:	e8 d6 1f 00 00       	call   39b7 <fork>
    ...
    1a08:	6a 00                	push   $0x0
    1a0a:	53                   	push   %ebx
    1a0b:	e8 ef 1f 00 00       	call   39ff <open>
    1a10:	89 04 24             	mov    %eax,(%esp)
    1a13:	e8 cf 1f 00 00       	call   39e7 <close>
      close(open(file, 0));
    1a18:	58                   	pop    %eax
    1a19:	5a                   	pop    %edx
    1a1a:	6a 00                	push   $0x0
    1a1c:	53                   	push   %ebx
    1a1d:	e8 dd 1f 00 00       	call   39ff <open>
    1a22:	89 04 24             	mov    %eax,(%esp)
    1a25:	e8 bd 1f 00 00       	call   39e7 <close>
      close(open(file, 0));
    1a2a:	59                   	pop    %ecx
    1a2b:	58                   	pop    %eax
    1a2c:	6a 00                	push   $0x0
    1a2e:	53                   	push   %ebx
    1a2f:	e8 cb 1f 00 00       	call   39ff <open>
    1a34:	89 04 24             	mov    %eax,(%esp)
    1a37:	e8 ab 1f 00 00       	call   39e7 <close>
      close(open(file, 0));
    1a3c:	58                   	pop    %eax
    1a3d:	5a                   	pop    %edx
    1a3e:	6a 00                	push   $0x0
    1a40:	53                   	push   %ebx
    1a41:	e8 b9 1f 00 00       	call   39ff <open>
    1a46:	89 04 24             	mov    %eax,(%esp)
    1a49:	e8 99 1f 00 00       	call   39e7 <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a81:	e8 8a 20 00 00       	call   3b10 <printf>
      exit();
    1a86:	e8 34 1f 00 00       	call   39bf <exit>
    ...
    exit();
    1a99:	e8 21 1f 00 00       	call   39bf <exit>
    ...
    1aac:	e8 5f 20 00 00       	call   3b10 <printf>
        exit();
    1ab1:	e8 09 1f 00 00       	call   39bf <exit>
    ...
    1ac4:	e8 47 20 00 00       	call   3b10 <printf>
        exit();
    1ac9:	e8 f1 1e 00 00       	call   39bf <exit>
      close(fd);
    1ace:	83 ec 0c             	sub    $0xc,%esp
    1ad1:	50                   	push   %eax
    1ad2:	e8 10 1f 00 00       	call   39e7 <close>
...
00001ae0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1afc:	e8 0e 1f 00 00       	call   3a0f <unlink>
  pid = fork();
    1b01:	e8 b1 1e 00 00       	call   39b7 <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b3d:	e8 cd 1e 00 00       	call   3a0f <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b76:	e8 84 1e 00 00       	call   39ff <open>
    1b7b:	89 04 24             	mov    %eax,(%esp)
    1b7e:	e8 64 1e 00 00       	call   39e7 <close>
  ...
  if(pid)
    ...
    wait();
    1b92:	e8 30 1e 00 00       	call   39c7 <wait>
  printf(1, "linkunlink ok\n");
    ...
    1bbd:	e8 5d 1e 00 00       	call   3a1f <link>
    ...
    exit();
    1bd8:	e8 e2 1d 00 00       	call   39bf <exit>
    exit();
    1bdd:	e8 dd 1d 00 00       	call   39bf <exit>
...
00001bf0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1c0c:	e8 fe 1d 00 00       	call   3a0f <unlink>
  fd = open("bd", O_CREATE);
    1c11:	5a                   	pop    %edx
    1c12:	59                   	pop    %ecx
    1c13:	68 00 02 00 00       	push   $0x200
    1c18:	68 35 45 00 00       	push   $0x4535
    1c1d:	e8 dd 1d 00 00       	call   39ff <open>
  if(fd < 0){
  ...
  close(fd);
    1c35:	50                   	push   %eax
    1c36:	e8 ac 1d 00 00       	call   39e7 <close>
    ...
    if(link("bd", name) != 0){
    1c67:	e8 b3 1d 00 00       	call   3a1f <link>
  ...
  unlink("bd");
    ...
    1c88:	e8 82 1d 00 00       	call   3a0f <unlink>
    ...
    if(unlink(name) != 0){
    1cb2:	e8 58 1d 00 00       	call   3a0f <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1ced:	e8 1e 1e 00 00       	call   3b10 <printf>
      exit();
    1cf2:	e8 c8 1c 00 00       	call   39bf <exit>
    ...
    1d01:	e8 0a 1e 00 00       	call   3b10 <printf>
      exit();
    1d06:	e8 b4 1c 00 00       	call   39bf <exit>
    ...
    exit();
    1d19:	e8 a1 1c 00 00       	call   39bf <exit>
...
00001d20 <subdir>:
{
  ...
  unlink("ff");
    ...
    1d3a:	e8 d0 1c 00 00       	call   3a0f <unlink>
  if(mkdir("dd") != 0){
    1d3f:	c7 04 24 a8 46 00 00 	movl   $0x46a8,(%esp)
    1d46:	e8 dc 1c 00 00       	call   3a27 <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d63:	e8 97 1c 00 00       	call   39ff <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d7f:	50                   	push   %eax
    1d80:	e8 5a 1c 00 00       	call   39df <write>
  close(fd);
    1d85:	89 1c 24             	mov    %ebx,(%esp)
    1d88:	e8 5a 1c 00 00       	call   39e7 <close>
  if(unlink("dd") >= 0){
    1d8d:	c7 04 24 a8 46 00 00 	movl   $0x46a8,(%esp)
    1d94:	e8 76 1c 00 00       	call   3a0f <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1dac:	e8 76 1c 00 00       	call   3a27 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dc9:	e8 31 1c 00 00       	call   39ff <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1de5:	50                   	push   %eax
    1de6:	e8 f4 1b 00 00       	call   39df <write>
  close(fd);
    1deb:	89 1c 24             	mov    %ebx,(%esp)
    1dee:	e8 f4 1b 00 00       	call   39e7 <close>
  fd = open("dd/dd/../ff", 0);
    1df3:	58                   	pop    %eax
    1df4:	5a                   	pop    %edx
    1df5:	6a 00                	push   $0x0
    1df7:	68 02 46 00 00       	push   $0x4602
    1dfc:	e8 fe 1b 00 00       	call   39ff <open>
  if(fd < 0){
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e67:	e8 a3 1b 00 00       	call   3a0f <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e81:	e8 79 1b 00 00       	call   39ff <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e99:	e8 91 1b 00 00       	call   3a2f <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1eb1:	e8 79 1b 00 00       	call   3a2f <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ec9:	e8 61 1b 00 00       	call   3a2f <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ee1:	e8 49 1b 00 00       	call   3a2f <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1efb:	e8 ff 1a 00 00       	call   39ff <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f15:	68 e0 86 00 00       	push   $0x86e0
    1f1a:	50                   	push   %eax
    1f1b:	e8 b7 1a 00 00       	call   39d7 <read>
  ...
  close(fd);
    ...
    1f2f:	53                   	push   %ebx
    1f30:	e8 b2 1a 00 00       	call   39e7 <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f35:	58                   	pop    %eax
    1f36:	5a                   	pop    %edx
    1f37:	6a 00                	push   $0x0
    1f39:	68 de 45 00 00       	push   $0x45de
    1f3e:	e8 bc 1a 00 00       	call   39ff <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f5b:	e8 9f 1a 00 00       	call   39ff <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f78:	e8 82 1a 00 00       	call   39ff <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f95:	e8 65 1a 00 00       	call   39ff <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1faf:	e8 4b 1a 00 00       	call   39ff <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fc9:	e8 31 1a 00 00       	call   39ff <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fe6:	e8 34 1a 00 00       	call   3a1f <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2003:	e8 17 1a 00 00       	call   3a1f <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2020:	e8 fa 19 00 00       	call   3a1f <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2038:	e8 ea 19 00 00       	call   3a27 <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2050:	e8 d2 19 00 00       	call   3a27 <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2068:	e8 ba 19 00 00       	call   3a27 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2080:	e8 8a 19 00 00       	call   3a0f <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2098:	e8 72 19 00 00       	call   3a0f <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20b0:	e8 7a 19 00 00       	call   3a2f <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20c8:	e8 62 19 00 00       	call   3a2f <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20e0:	e8 2a 19 00 00       	call   3a0f <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20f8:	e8 12 19 00 00       	call   3a0f <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2110:	e8 fa 18 00 00       	call   3a0f <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2128:	e8 e2 18 00 00       	call   3a0f <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2140:	e8 ca 18 00 00       	call   3a0f <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    exit();
    2175:	e8 45 18 00 00       	call   39bf <exit>
    ...
    exit();
    2188:	e8 32 18 00 00       	call   39bf <exit>
    ...
    exit();
    219b:	e8 1f 18 00 00       	call   39bf <exit>
    ...
    exit();
    21ae:	e8 0c 18 00 00       	call   39bf <exit>
    ...
    exit();
    21c1:	e8 f9 17 00 00       	call   39bf <exit>
    ...
    exit();
    21d4:	e8 e6 17 00 00       	call   39bf <exit>
    ...
    exit();
    21e7:	e8 d3 17 00 00       	call   39bf <exit>
    ...
    exit();
    21fa:	e8 c0 17 00 00       	call   39bf <exit>
    ...
    exit();
    220d:	e8 ad 17 00 00       	call   39bf <exit>
    ...
    exit();
    2220:	e8 9a 17 00 00       	call   39bf <exit>
    ...
    exit();
    2233:	e8 87 17 00 00       	call   39bf <exit>
    ...
    exit();
    2246:	e8 74 17 00 00       	call   39bf <exit>
    ...
    exit();
    2259:	e8 61 17 00 00       	call   39bf <exit>
    ...
    exit();
    226c:	e8 4e 17 00 00       	call   39bf <exit>
    ...
    exit();
    227f:	e8 3b 17 00 00       	call   39bf <exit>
    ...
    exit();
    2292:	e8 28 17 00 00       	call   39bf <exit>
    ...
    exit();
    22a5:	e8 15 17 00 00       	call   39bf <exit>
    ...
    exit();
    22b8:	e8 02 17 00 00       	call   39bf <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22bd:	50                   	push   %eax
    22be:	50                   	push   %eax
    ...
    exit();
    22cb:	e8 ef 16 00 00       	call   39bf <exit>
    ...
    exit();
    22de:	e8 dc 16 00 00       	call   39bf <exit>
    ...
    exit();
    22f1:	e8 c9 16 00 00       	call   39bf <exit>
    ...
    exit();
    2304:	e8 b6 16 00 00       	call   39bf <exit>
    ...
    exit();
    2317:	e8 a3 16 00 00       	call   39bf <exit>
    ...
    exit();
    232a:	e8 90 16 00 00       	call   39bf <exit>
    ...
    exit();
    233d:	e8 7d 16 00 00       	call   39bf <exit>
    ...
    exit();
    2350:	e8 6a 16 00 00       	call   39bf <exit>
    ...
    exit();
    2363:	e8 57 16 00 00       	call   39bf <exit>
    ...
    exit();
    2376:	e8 44 16 00 00       	call   39bf <exit>
    ...
    exit();
    2389:	e8 31 16 00 00       	call   39bf <exit>
    ...
    exit();
    239c:	e8 1e 16 00 00       	call   39bf <exit>
    ...
    exit();
    23af:	e8 0b 16 00 00       	call   39bf <exit>
    ...
    exit();
    23c2:	e8 f8 15 00 00       	call   39bf <exit>
    ...
    exit();
    23d5:	e8 e5 15 00 00       	call   39bf <exit>
    ...
    exit();
    23e8:	e8 d2 15 00 00       	call   39bf <exit>
    ...
    exit();
    23fb:	e8 bf 15 00 00       	call   39bf <exit>
...
00002400 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    2420:	e8 ea 15 00 00       	call   3a0f <unlink>
    ...
    243d:	e8 bd 15 00 00       	call   39ff <open>
    if(fd < 0){
    ...
    244e:	53                   	push   %ebx
    244f:	68 e0 86 00 00       	push   $0x86e0
    2454:	50                   	push   %eax
    2455:	e8 85 15 00 00       	call   39df <write>
      if(cc != sz){
    ...
    2464:	53                   	push   %ebx
    2465:	68 e0 86 00 00       	push   $0x86e0
    246a:	56                   	push   %esi
    246b:	e8 6f 15 00 00       	call   39df <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2480:	56                   	push   %esi
    2481:	e8 61 15 00 00       	call   39e7 <close>
    unlink("bigwrite");
    2486:	c7 04 24 a4 48 00 00 	movl   $0x48a4,(%esp)
    248d:	e8 7d 15 00 00       	call   3a0f <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24bf:	e8 4c 16 00 00       	call   3b10 <printf>
        exit();
    24c4:	e8 f6 14 00 00       	call   39bf <exit>
    ...
    24d3:	e8 38 16 00 00       	call   3b10 <printf>
      exit();
    24d8:	e8 e2 14 00 00       	call   39bf <exit>
...
000024e0 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    24fc:	e8 0e 15 00 00       	call   3a0f <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2501:	58                   	pop    %eax
    2502:	5a                   	pop    %edx
    2503:	68 02 02 00 00       	push   $0x202
    2508:	68 00 49 00 00       	push   $0x4900
    250d:	e8 ed 14 00 00       	call   39ff <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2530:	53                   	push   %ebx
    2531:	68 e0 86 00 00       	push   $0x86e0
    2536:	e8 05 12 00 00       	call   3740 <memset>
    if(write(fd, buf, 600) != 600){
    253b:	83 c4 0c             	add    $0xc,%esp
    253e:	68 58 02 00 00       	push   $0x258
    2543:	68 e0 86 00 00       	push   $0x86e0
    2548:	56                   	push   %esi
    2549:	e8 91 14 00 00       	call   39df <write>
  ...
  close(fd);
    ...
    2567:	56                   	push   %esi
    2568:	e8 7a 14 00 00       	call   39e7 <close>
  fd = open("bigfile", 0);
    256d:	5e                   	pop    %esi
    256e:	5f                   	pop    %edi
    256f:	6a 00                	push   $0x0
    2571:	68 00 49 00 00       	push   $0x4900
    2576:	e8 84 14 00 00       	call   39ff <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    259d:	0f be 05 e0 86 00 00 	movsbl 0x86e0,%eax
    25a4:	d1 fa                	sar    %edx
    25a6:	39 d0                	cmp    %edx,%eax
    25a8:	75 6e                	jne    2618 <bigfile+0x138>
    25aa:	0f be 15 0b 88 00 00 	movsbl 0x880b,%edx
  ...
  for(i = 0; ; i++){
    ...
    25c6:	68 e0 86 00 00       	push   $0x86e0
    25cb:	56                   	push   %esi
    25cc:	e8 06 14 00 00       	call   39d7 <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25dd:	56                   	push   %esi
    25de:	e8 04 14 00 00       	call   39e7 <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25fa:	e8 10 14 00 00       	call   3a0f <unlink>
  printf(1, "bigfile test ok\n");
    ...
    2622:	e8 e9 14 00 00       	call   3b10 <printf>
      exit();
    2627:	e8 93 13 00 00       	call   39bf <exit>
    ...
    2636:	e8 d5 14 00 00       	call   3b10 <printf>
      exit();
    263b:	e8 7f 13 00 00       	call   39bf <exit>
    ...
    264a:	e8 c1 14 00 00       	call   3b10 <printf>
      exit();
    264f:	e8 6b 13 00 00       	call   39bf <exit>
    ...
    265e:	e8 ad 14 00 00       	call   3b10 <printf>
      exit();
    2663:	e8 57 13 00 00       	call   39bf <exit>
    ...
    exit();
    2676:	e8 44 13 00 00       	call   39bf <exit>
    ...
    exit();
    2689:	e8 31 13 00 00       	call   39bf <exit>
    ...
    exit();
    269c:	e8 1e 13 00 00       	call   39bf <exit>
...
000026b0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26c9:	e8 59 13 00 00       	call   3a27 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26e1:	e8 41 13 00 00       	call   3a27 <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26fe:	e8 fc 12 00 00       	call   39ff <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2711:	50                   	push   %eax
    2712:	e8 d0 12 00 00       	call   39e7 <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2717:	58                   	pop    %eax
    2718:	5a                   	pop    %edx
    2719:	6a 00                	push   $0x0
    271b:	68 58 52 00 00       	push   $0x5258
    2720:	e8 da 12 00 00       	call   39ff <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    272f:	50                   	push   %eax
    2730:	e8 b2 12 00 00       	call   39e7 <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2735:	c7 04 24 cc 49 00 00 	movl   $0x49cc,(%esp)
    273c:	e8 e6 12 00 00       	call   3a27 <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2750:	e8 d2 12 00 00       	call   3a27 <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    277e:	e8 3c 12 00 00       	call   39bf <exit>
    ...
    exit();
    2791:	e8 29 12 00 00       	call   39bf <exit>
    ...
    exit();
    27a4:	e8 16 12 00 00       	call   39bf <exit>
    ...
    exit();
    27b7:	e8 03 12 00 00       	call   39bf <exit>
    ...
    exit();
    27ca:	e8 f0 11 00 00       	call   39bf <exit>
    ...
    exit();
    27dd:	e8 dd 11 00 00       	call   39bf <exit>
...
000027f0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    2809:	e8 19 12 00 00       	call   3a27 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2821:	e8 09 12 00 00       	call   3a2f <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2839:	e8 d1 11 00 00       	call   3a0f <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2851:	e8 b9 11 00 00       	call   3a0f <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2869:	e8 c1 11 00 00       	call   3a2f <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2881:	e8 89 11 00 00       	call   3a0f <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2895:	e8 75 11 00 00       	call   3a0f <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    28a9:	e8 61 11 00 00       	call   3a0f <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    28d7:	e8 e3 10 00 00       	call   39bf <exit>
    ...
    exit();
    28ea:	e8 d0 10 00 00       	call   39bf <exit>
    ...
    exit();
    28fd:	e8 bd 10 00 00       	call   39bf <exit>
    printf(1, "unlink dots/. worked!\n");
    2902:	51                   	push   %ecx
    2903:	51                   	push   %ecx
    ...
    exit();
    2910:	e8 aa 10 00 00       	call   39bf <exit>
    printf(1, "chdir / failed\n");
    2915:	50                   	push   %eax
    2916:	50                   	push   %eax
    ...
    exit();
    2923:	e8 97 10 00 00       	call   39bf <exit>
    printf(1, "rm .. worked!\n");
    2928:	50                   	push   %eax
    2929:	50                   	push   %eax
    ...
    exit();
    2936:	e8 84 10 00 00       	call   39bf <exit>
    printf(1, "rm . worked!\n");
    293b:	50                   	push   %eax
    293c:	50                   	push   %eax
    ...
    exit();
    2949:	e8 71 10 00 00       	call   39bf <exit>
    ...
    exit();
    295c:	e8 5e 10 00 00       	call   39bf <exit>
...
00002970 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    298f:	e8 6b 10 00 00       	call   39ff <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    29a2:	50                   	push   %eax
    29a3:	e8 3f 10 00 00       	call   39e7 <close>
  if(chdir("dirfile") == 0){
    29a8:	c7 04 24 b5 4a 00 00 	movl   $0x4ab5,(%esp)
    29af:	e8 7b 10 00 00       	call   3a2f <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29c9:	e8 31 10 00 00       	call   39ff <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29e6:	e8 14 10 00 00       	call   39ff <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29fe:	e8 24 10 00 00       	call   3a27 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a16:	e8 f4 0f 00 00       	call   3a0f <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a33:	e8 e7 0f 00 00       	call   3a1f <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a4b:	e8 bf 0f 00 00       	call   3a0f <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a65:	e8 95 0f 00 00       	call   39ff <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a7f:	e8 7b 0f 00 00       	call   39ff <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a90:	50                   	push   %eax
    2a91:	e8 49 0f 00 00       	call   39df <write>
  ...
  close(fd);
    ...
    2aa0:	53                   	push   %ebx
    2aa1:	e8 41 0f 00 00       	call   39e7 <close>
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2aca:	e8 f0 0e 00 00       	call   39bf <exit>
    ...
    exit();
    2add:	e8 dd 0e 00 00       	call   39bf <exit>
    ...
    exit();
    2af0:	e8 ca 0e 00 00       	call   39bf <exit>
    ...
    exit();
    2b03:	e8 b7 0e 00 00       	call   39bf <exit>
    ...
    exit();
    2b16:	e8 a4 0e 00 00       	call   39bf <exit>
    ...
    exit();
    2b29:	e8 91 0e 00 00       	call   39bf <exit>
    ...
    exit();
    2b3c:	e8 7e 0e 00 00       	call   39bf <exit>
    ...
    exit();
    2b4f:	e8 6b 0e 00 00       	call   39bf <exit>
    ...
    exit();
    2b62:	e8 58 0e 00 00       	call   39bf <exit>
    ...
    2b74:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b98:	e8 8a 0e 00 00       	call   3a27 <mkdir>
    ...
    2bb0:	e8 7a 0e 00 00       	call   3a2f <chdir>
    ...
    2c1e:	50                   	push   %eax
    2c1f:	e8 c3 0d 00 00       	call   39e7 <close>
    2c24:	83 c4 10             	add    $0x10,%esp
    unlink("xx");
    2c27:	83 ec 0c             	sub    $0xc,%esp
    2c2a:	68 90 47 00 00       	push   $0x4790
    2c2f:	e8 db 0d 00 00       	call   3a0f <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2c48:	e8 e2 0d 00 00       	call   3a2f <chdir>
  printf(1, "empty file name OK\n");
    ...
    2c6d:	e8 9e 0e 00 00       	call   3b10 <printf>
      exit();
    2c72:	e8 48 0d 00 00       	call   39bf <exit>
    ...
    2c81:	e8 8a 0e 00 00       	call   3b10 <printf>
      exit();
    2c86:	e8 34 0d 00 00       	call   39bf <exit>
    ...
    2c94:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cbd:	e8 f5 0c 00 00       	call   39b7 <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cd0:	e8 f2 0c 00 00       	call   39c7 <wait>
  ...
  if(wait() != -1){
    2cde:	e8 e4 0c 00 00       	call   39c7 <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2cfb:	c3                   	ret    
      exit();
    2cfc:	e8 be 0c 00 00       	call   39bf <exit>
    ...
    2d0b:	e8 00 0e 00 00       	call   3b10 <printf>
      exit();
    2d10:	e8 aa 0c 00 00       	call   39bf <exit>
    ...
    exit();
    2d23:	e8 97 0c 00 00       	call   39bf <exit>
    ...
    exit();
    2d36:	e8 84 0c 00 00       	call   39bf <exit>
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d85:	6a 01                	push   $0x1
    2d87:	e8 bb 0c 00 00       	call   3a47 <sbrk>
    if(b != a){
  ...
  pid = fork();
    2da8:	e8 0a 0c 00 00       	call   39b7 <fork>
  ...
  c = sbrk(1);
    2dbd:	6a 01                	push   $0x1
    2dbf:	e8 83 0c 00 00       	call   3a47 <sbrk>
  c = sbrk(1);
    2dc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dcb:	e8 77 0c 00 00       	call   3a47 <sbrk>
  if(c != a + 1){
  ...
  wait();
    2de3:	e8 df 0b 00 00       	call   39c7 <wait>
  a = sbrk(0);
    2de8:	83 ec 0c             	sub    $0xc,%esp
    2deb:	6a 00                	push   $0x0
    2ded:	e8 55 0c 00 00       	call   3a47 <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dfe:	e8 44 0c 00 00       	call   3a47 <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2e18:	6a 00                	push   $0x0
    2e1a:	e8 28 0c 00 00       	call   3a47 <sbrk>
  c = sbrk(-4096);
    2e1f:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e26:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e28:	e8 1a 0c 00 00       	call   3a47 <sbrk>
  ...
  c = sbrk(0);
    ...
    2e3c:	6a 00                	push   $0x0
    2e3e:	e8 04 0c 00 00       	call   3a47 <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e57:	6a 00                	push   $0x0
    2e59:	e8 e9 0b 00 00       	call   3a47 <sbrk>
  c = sbrk(4096);
    2e5e:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e65:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e67:	e8 db 0b 00 00       	call   3a47 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e7c:	6a 00                	push   $0x0
    2e7e:	e8 c4 0b 00 00       	call   3a47 <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2edf:	90                   	nop
    ppid = getpid();
    2ee0:	e8 5a 0b 00 00       	call   3a3f <getpid>
    2ee5:	89 c6                	mov    %eax,%esi
    pid = fork();
    2ee7:	e8 cb 0a 00 00       	call   39b7 <fork>
    if(pid < 0){
    ...
    wait();
    2efa:	e8 c8 0a 00 00       	call   39c7 <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f13:	50                   	push   %eax
    2f14:	e8 b6 0a 00 00       	call   39cf <pipe>
    ...
    if((pids[i] = fork()) == 0){
    2f30:	e8 82 0a 00 00       	call   39b7 <fork>
    ...
    2f50:	e8 82 0a 00 00       	call   39d7 <read>
  ...
  c = sbrk(4096);
    ...
    2f67:	e8 db 0a 00 00       	call   3a47 <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f82:	50                   	push   %eax
    2f83:	e8 67 0a 00 00       	call   39ef <kill>
    wait();
    2f88:	e8 3a 0a 00 00       	call   39c7 <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2fa3:	6a 00                	push   $0x0
    2fa5:	e8 9d 0a 00 00       	call   3a47 <sbrk>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fba:	ff 35 90 5f 00 00    	push   0x5f90
    ...
    exit();
    310c:	e8 ae 08 00 00       	call   39bf <exit>
    exit();
    3111:	e8 a9 08 00 00       	call   39bf <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    3116:	57                   	push   %edi
    3117:	57                   	push   %edi
    3118:	68 65 4c 00 00       	push   $0x4c65
    311d:	ff 35 90 5f 00 00    	push   0x5f90
    3123:	e8 e8 09 00 00       	call   3b10 <printf>
    exit();
    3128:	e8 92 08 00 00       	call   39bf <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    312d:	56                   	push   %esi
    312e:	53                   	push   %ebx
    312f:	68 24 54 00 00       	push   $0x5424
    3134:	ff 35 90 5f 00 00    	push   0x5f90
    313a:	e8 d1 09 00 00       	call   3b10 <printf>
    exit();
    313f:	e8 7b 08 00 00       	call   39bf <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3144:	50                   	push   %eax
    3145:	53                   	push   %ebx
    3146:	68 ec 53 00 00       	push   $0x53ec
    314b:	ff 35 90 5f 00 00    	push   0x5f90
    3151:	e8 ba 09 00 00       	call   3b10 <printf>
    exit();
    3156:	e8 64 08 00 00       	call   39bf <exit>
    printf(stdout, "sbrk could not deallocate\n");
    315b:	53                   	push   %ebx
    315c:	53                   	push   %ebx
    315d:	68 81 4c 00 00       	push   $0x4c81
    3162:	ff 35 90 5f 00 00    	push   0x5f90
    3168:	e8 a3 09 00 00       	call   3b10 <printf>
    exit();
    316d:	e8 4d 08 00 00       	call   39bf <exit>
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    31be:	6a 00                	push   $0x0
    31c0:	e8 8a 08 00 00       	call   3a4f <sleep>
    sleep(0);
    31c5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31cc:	e8 7e 08 00 00       	call   3a4f <sleep>
    kill(pid);
    31d1:	89 1c 24             	mov    %ebx,(%esp)
    31d4:	e8 16 08 00 00       	call   39ef <kill>
    wait();
    31d9:	e8 e9 07 00 00       	call   39c7 <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31de:	58                   	pop    %eax
    31df:	5a                   	pop    %edx
    31e0:	56                   	push   %esi
    31e1:	68 ed 4c 00 00       	push   $0x4ced
    31e6:	e8 34 08 00 00       	call   3a1f <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    3209:	ff 35 90 5f 00 00    	push   0x5f90
    ...
    321d:	c3                   	ret    
      exit();
    321e:	e8 9c 07 00 00       	call   39bf <exit>
      printf(stdout, "link should not succeed\n");
    3223:	83 ec 08             	sub    $0x8,%esp
    3226:	68 f8 4c 00 00       	push   $0x4cf8
    322b:	ff 35 90 5f 00 00    	push   0x5f90
    3231:	e8 da 08 00 00       	call   3b10 <printf>
      exit();
    3236:	e8 84 07 00 00       	call   39bf <exit>
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    324b:	ff 35 90 5f 00 00    	push   0x5f90
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    325f:	90                   	nop
    if(uninit[i] != '\0'){
    3260:	80 b8 c0 5f 00 00 00 	cmpb   $0x0,0x5fc0(%eax)
  ...
  printf(stdout, "bss test ok\n");
    ...
    327b:	ff 35 90 5f 00 00    	push   0x5f90
    ...
    3293:	ff 35 90 5f 00 00    	push   0x5f90
    3299:	e8 72 08 00 00       	call   3b10 <printf>
      exit();
    329e:	e8 1c 07 00 00       	call   39bf <exit>
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32bb:	e8 4f 07 00 00       	call   3a0f <unlink>
  pid = fork();
    32c0:	e8 f2 06 00 00       	call   39b7 <fork>
  if(pid == 0){
  ...
  wait();
    32d2:	e8 f0 06 00 00       	call   39c7 <wait>
  fd = open("bigarg-ok", 0);
    32d7:	83 ec 08             	sub    $0x8,%esp
    32da:	6a 00                	push   $0x0
    32dc:	68 46 4d 00 00       	push   $0x4d46
    32e1:	e8 19 07 00 00       	call   39ff <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32f4:	50                   	push   %eax
    32f5:	e8 ed 06 00 00       	call   39e7 <close>
  unlink("bigarg-ok");
    32fa:	c7 04 24 46 4d 00 00 	movl   $0x4d46,(%esp)
    3301:	e8 09 07 00 00       	call   3a0f <unlink>
}
    ...
    3310:	c7 04 85 e0 a6 00 00 	movl   $0x54a0,0xa6e0(,%eax,4)
    3317:	a0 54 00 00 
    ...
    332a:	ff 35 90 5f 00 00    	push   0x5f90
    args[MAXARG-1] = 0;
    3330:	c7 05 5c a7 00 00 00 	movl   $0x0,0xa75c
    3337:	00 00 00 
    printf(stdout, "bigarg test\n");
    ...
    333f:	58                   	pop    %eax
    3340:	5a                   	pop    %edx
    3341:	68 e0 a6 00 00       	push   $0xa6e0
    3346:	68 1d 3f 00 00       	push   $0x3f1d
    334b:	e8 a7 06 00 00       	call   39f7 <exec>
    printf(stdout, "bigarg test ok\n");
    3350:	59                   	pop    %ecx
    3351:	58                   	pop    %eax
    3352:	68 5d 4d 00 00       	push   $0x4d5d
    3357:	ff 35 90 5f 00 00    	push   0x5f90
    ...
    336e:	e8 8c 06 00 00       	call   39ff <open>
    close(fd);
    3373:	89 04 24             	mov    %eax,(%esp)
    3376:	e8 6c 06 00 00       	call   39e7 <close>
    exit();
    337b:	e8 3f 06 00 00       	call   39bf <exit>
    printf(stdout, "bigarg test failed!\n");
    3380:	50                   	push   %eax
    3381:	50                   	push   %eax
    3382:	68 86 4d 00 00       	push   $0x4d86
    3387:	ff 35 90 5f 00 00    	push   0x5f90
    338d:	e8 7e 07 00 00       	call   3b10 <printf>
    exit();
    3392:	e8 28 06 00 00       	call   39bf <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3397:	52                   	push   %edx
    3398:	52                   	push   %edx
    3399:	68 6d 4d 00 00       	push   $0x4d6d
    339e:	ff 35 90 5f 00 00    	push   0x5f90
    33a4:	e8 67 07 00 00       	call   3b10 <printf>
    exit();
    33a9:	e8 11 06 00 00       	call   39bf <exit>
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    ...
    3458:	50                   	push   %eax
    3459:	e8 a1 05 00 00       	call   39ff <open>
    if(fd < 0){
    ...
    347a:	68 e0 86 00 00       	push   $0x86e0
    347f:	57                   	push   %edi
    3480:	e8 5a 05 00 00       	call   39df <write>
      if(cc < 512)
    ...
    34a2:	e8 40 05 00 00       	call   39e7 <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    354b:	50                   	push   %eax
    354c:	e8 be 04 00 00       	call   3a0f <unlink>
  while(nfiles >= 0){
...
00003580 <uio>:
{
  ...
  pid = fork();
    3592:	e8 20 04 00 00       	call   39b7 <fork>
  if(pid == 0){
  ...
  wait();
    35a0:	e8 22 04 00 00       	call   39c7 <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    35d8:	e8 e2 03 00 00       	call   39bf <exit>
    printf (1, "fork failed\n");
    35dd:	50                   	push   %eax
    35de:	50                   	push   %eax
    ...
    exit();
    35eb:	e8 cf 03 00 00       	call   39bf <exit>
...
000035f0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35fe:	e8 fc 03 00 00       	call   39ff <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    360f:	6a 00                	push   $0x0
    3611:	e8 31 04 00 00       	call   3a47 <sbrk>
    3616:	83 c4 0c             	add    $0xc,%esp
    3619:	83 e8 01             	sub    $0x1,%eax
    361c:	6a ff                	push   $0xffffffff
    361e:	50                   	push   %eax
    361f:	53                   	push   %ebx
    3620:	e8 b2 03 00 00       	call   39d7 <read>
  close(fd);
    3625:	89 1c 24             	mov    %ebx,(%esp)
    3628:	e8 ba 03 00 00       	call   39e7 <close>
    ...
    37a9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    37b5:	57                   	push   %edi
    37b6:	6a 00                	push   $0x0
    37b8:	e8 1a 02 00 00       	call   39d7 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    381d:	e8 dd 01 00 00       	call   39ff <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3831:	50                   	push   %eax
    3832:	e8 e0 01 00 00       	call   3a17 <fstat>
  close(fd);
    3837:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    383a:	89 c6                	mov    %eax,%esi
  close(fd);
    383c:	e8 a6 01 00 00       	call   39e7 <close>
  return r;
...
char* strcat(char* dest, const char* source)
{
    ...
    38d3:	53                   	push   %ebx
    38d4:	8b 5d 08             	mov    0x8(%ebp),%ebx
    38d7:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  for(n = 0; s[n]; n++)
    38da:	80 3b 00             	cmpb   $0x0,(%ebx)
    38dd:	74 41                	je     3920 <strcat+0x50>
    38df:	8d 53 01             	lea    0x1(%ebx),%edx
    38e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    38e8:	89 d0                	mov    %edx,%eax
    38ea:	83 c2 01             	add    $0x1,%edx
    38ed:	80 7a ff 00          	cmpb   $0x0,-0x1(%edx)
    38f1:	75 f5                	jne    38e8 <strcat+0x18>
	char* ptr = dest + strlen(dest);
	while (*source != '\0')
    38f3:	0f b6 11             	movzbl (%ecx),%edx
    38f6:	84 d2                	test   %dl,%dl
    38f8:	74 15                	je     390f <strcat+0x3f>
    38fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		*ptr++ = *source++;
    3900:	88 10                	mov    %dl,(%eax)
    3902:	83 c0 01             	add    $0x1,%eax
    3905:	83 c1 01             	add    $0x1,%ecx
	while (*source != '\0')
    3908:	0f b6 11             	movzbl (%ecx),%edx
    390b:	84 d2                	test   %dl,%dl
    390d:	75 f1                	jne    3900 <strcat+0x30>
	*ptr = '\0';
    390f:	c6 00 00             	movb   $0x0,(%eax)
	return dest;
}
    3912:	89 d8                	mov    %ebx,%eax
    3914:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3917:	c9                   	leave  
    3918:	c3                   	ret    
    3919:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(n = 0; s[n]; n++)
    3920:	89 d8                	mov    %ebx,%eax
	while (*source != '\0')
    3922:	eb e4                	jmp    3908 <strcat+0x38>
    3924:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
char *strtok(char *str, const char *delim) {
    3937:	8b 7d 0c             	mov    0xc(%ebp),%edi
    393a:	56                   	push   %esi
    393b:	53                   	push   %ebx
    if (str != NULL) {
    393c:	85 c0                	test   %eax,%eax
    393e:	74 6d                	je     39ad <strtok+0x7d>
        last_token = str;
    3940:	8b 45 08             	mov    0x8(%ebp),%eax
    3943:	a3 60 a7 00 00       	mov    %eax,0xa760
    }

    while (*last_token != '\0') {
    3948:	8b 45 08             	mov    0x8(%ebp),%eax
    394b:	0f b6 08             	movzbl (%eax),%ecx
    394e:	84 c9                	test   %cl,%cl
    3950:	74 54                	je     39a6 <strtok+0x76>
        const char *d = delim;
        while (*d != '\0') {
    3952:	0f b6 37             	movzbl (%edi),%esi
    3955:	8d 76 00             	lea    0x0(%esi),%esi
    3958:	89 f0                	mov    %esi,%eax
    395a:	89 fa                	mov    %edi,%edx
    395c:	84 c0                	test   %al,%al
    395e:	75 13                	jne    3973 <strtok+0x43>
    3960:	eb 2e                	jmp    3990 <strtok+0x60>
    3962:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    3968:	0f b6 42 01          	movzbl 0x1(%edx),%eax
            if (*last_token == *d) {
                delim_found = 1;
                break;
            }
            d++;
    396c:	83 c2 01             	add    $0x1,%edx
        while (*d != '\0') {
    396f:	84 c0                	test   %al,%al
    3971:	74 1d                	je     3990 <strtok+0x60>
            if (*last_token == *d) {
    3973:	38 c8                	cmp    %cl,%al
    3975:	75 f1                	jne    3968 <strtok+0x38>
        }
        if (delim_found) {
            *last_token = '\0';
    3977:	8b 45 08             	mov    0x8(%ebp),%eax
    397a:	c6 00 00             	movb   $0x0,(%eax)
            token = last_token - (strlen(last_token) - 1);
    397d:	83 c0 01             	add    $0x1,%eax
        }
        last_token++;
    }
    ...
    3982:	5f                   	pop    %edi
            last_token++;
    3983:	a3 60 a7 00 00       	mov    %eax,0xa760
}
    3988:	5d                   	pop    %ebp
    3989:	c3                   	ret    
    398a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        last_token++;
    3990:	83 45 08 01          	addl   $0x1,0x8(%ebp)
    while (*last_token != '\0') {
    3994:	8b 45 08             	mov    0x8(%ebp),%eax
    3997:	0f b6 08             	movzbl (%eax),%ecx
    399a:	84 c9                	test   %cl,%cl
    399c:	75 ba                	jne    3958 <strtok+0x28>
    399e:	8b 45 08             	mov    0x8(%ebp),%eax
    39a1:	a3 60 a7 00 00       	mov    %eax,0xa760
}
    39a6:	5b                   	pop    %ebx
    return NULL;
    ...
    39ac:	c3                   	ret    
    while (*last_token != '\0') {
    39ad:	a1 60 a7 00 00       	mov    0xa760,%eax
    39b2:	89 45 08             	mov    %eax,0x8(%ebp)
    39b5:	eb 91                	jmp    3948 <strtok+0x18>
...
SYSCALL(fork)
    39b7:	b8 01 00 00 00       	mov    $0x1,%eax
    39bc:	cd 40                	int    $0x40
    39be:	c3                   	ret    

000039bf <exit>:
SYSCALL(exit)
    39bf:	b8 02 00 00 00       	mov    $0x2,%eax
    39c4:	cd 40                	int    $0x40
    39c6:	c3                   	ret    

000039c7 <wait>:
SYSCALL(wait)
    39c7:	b8 03 00 00 00       	mov    $0x3,%eax
    39cc:	cd 40                	int    $0x40
    39ce:	c3                   	ret    

000039cf <pipe>:
SYSCALL(pipe)
    39cf:	b8 04 00 00 00       	mov    $0x4,%eax
    39d4:	cd 40                	int    $0x40
    39d6:	c3                   	ret    

000039d7 <read>:
SYSCALL(read)
    39d7:	b8 05 00 00 00       	mov    $0x5,%eax
    39dc:	cd 40                	int    $0x40
    39de:	c3                   	ret    

000039df <write>:
SYSCALL(write)
    39df:	b8 10 00 00 00       	mov    $0x10,%eax
    39e4:	cd 40                	int    $0x40
    39e6:	c3                   	ret    

000039e7 <close>:
SYSCALL(close)
    39e7:	b8 15 00 00 00       	mov    $0x15,%eax
    39ec:	cd 40                	int    $0x40
    39ee:	c3                   	ret    

000039ef <kill>:
SYSCALL(kill)
    39ef:	b8 06 00 00 00       	mov    $0x6,%eax
    39f4:	cd 40                	int    $0x40
    39f6:	c3                   	ret    

000039f7 <exec>:
SYSCALL(exec)
    39f7:	b8 07 00 00 00       	mov    $0x7,%eax
    39fc:	cd 40                	int    $0x40
    39fe:	c3                   	ret    

000039ff <open>:
SYSCALL(open)
    39ff:	b8 0f 00 00 00       	mov    $0xf,%eax
    3a04:	cd 40                	int    $0x40
    3a06:	c3                   	ret    

00003a07 <mknod>:
SYSCALL(mknod)
    3a07:	b8 11 00 00 00       	mov    $0x11,%eax
    3a0c:	cd 40                	int    $0x40
    3a0e:	c3                   	ret    

00003a0f <unlink>:
SYSCALL(unlink)
    3a0f:	b8 12 00 00 00       	mov    $0x12,%eax
    3a14:	cd 40                	int    $0x40
    3a16:	c3                   	ret    

00003a17 <fstat>:
SYSCALL(fstat)
    3a17:	b8 08 00 00 00       	mov    $0x8,%eax
    3a1c:	cd 40                	int    $0x40
    3a1e:	c3                   	ret    

00003a1f <link>:
SYSCALL(link)
    3a1f:	b8 13 00 00 00       	mov    $0x13,%eax
    3a24:	cd 40                	int    $0x40
    3a26:	c3                   	ret    

00003a27 <mkdir>:
SYSCALL(mkdir)
    3a27:	b8 14 00 00 00       	mov    $0x14,%eax
    3a2c:	cd 40                	int    $0x40
    3a2e:	c3                   	ret    

00003a2f <chdir>:
SYSCALL(chdir)
    3a2f:	b8 09 00 00 00       	mov    $0x9,%eax
    3a34:	cd 40                	int    $0x40
    3a36:	c3                   	ret    

00003a37 <dup>:
SYSCALL(dup)
    3a37:	b8 0a 00 00 00       	mov    $0xa,%eax
    3a3c:	cd 40                	int    $0x40
    3a3e:	c3                   	ret    

00003a3f <getpid>:
SYSCALL(getpid)
    3a3f:	b8 0b 00 00 00       	mov    $0xb,%eax
    3a44:	cd 40                	int    $0x40
    3a46:	c3                   	ret    

00003a47 <sbrk>:
SYSCALL(sbrk)
    3a47:	b8 0c 00 00 00       	mov    $0xc,%eax
    3a4c:	cd 40                	int    $0x40
    3a4e:	c3                   	ret    

00003a4f <sleep>:
SYSCALL(sleep)
    3a4f:	b8 0d 00 00 00       	mov    $0xd,%eax
    3a54:	cd 40                	int    $0x40
    3a56:	c3                   	ret    

00003a57 <uptime>:
SYSCALL(uptime)
    3a57:	b8 0e 00 00 00       	mov    $0xe,%eax
    3a5c:	cd 40                	int    $0x40
    3a5e:	c3                   	ret    
    3a5f:	90                   	nop
    ...
    3a6c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    3a99:	0f b6 92 30 56 00 00 	movzbl 0x5630(%edx),%edx
  ...
  write(fd, &c, 1);
    ...
    3ade:	56                   	push   %esi
    3adf:	57                   	push   %edi
    3ae0:	e8 fa fe ff ff       	call   39df <write>
  while(--i >= 0)
    ...
    3b19:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    3b55:	57                   	push   %edi
    3b56:	56                   	push   %esi
    3b57:	e8 83 fe ff ff       	call   39df <write>
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3b89:	ff 24 85 d8 55 00 00 	jmp    *0x55d8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    3bae:	e8 2c fe ff ff       	call   39df <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3bbf:	57                   	push   %edi
    3bc0:	56                   	push   %esi
    3bc1:	e8 19 fe ff ff       	call   39df <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3c2b:	57                   	push   %edi
    3c2c:	56                   	push   %esi
    3c2d:	e8 ad fd ff ff       	call   39df <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    3c6f:	e8 6b fd ff ff       	call   39df <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    3c97:	90                   	nop
          s = "(null)";
    3c98:	ba ce 55 00 00       	mov    $0x55ce,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3cb1:	a1 64 a7 00 00       	mov    0xa764,%eax
{
  ...
  freep = p;
    ...
    3cf1:	5b                   	pop    %ebx
  freep = p;
    3cf2:	89 15 64 a7 00 00    	mov    %edx,0xa764
}
    3cf8:	5e                   	pop    %esi
    3cf9:	5f                   	pop    %edi
    3cfa:	5d                   	pop    %ebp
  ...
  freep = p;
    3d2c:	89 15 64 a7 00 00    	mov    %edx,0xa764
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3d4c:	8b 3d 64 a7 00 00    	mov    0xa764,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    3d91:	8b 3d 64 a7 00 00    	mov    0xa764,%edi
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3da3:	e8 9f fc ff ff       	call   3a47 <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    3dbf:	8b 15 64 a7 00 00    	mov    0xa764,%edx
    ...
    3dec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    3def:	89 15 64 a7 00 00    	mov    %edx,0xa764
}
    ...
    3dff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    3e00:	c7 05 64 a7 00 00 68 	movl   $0xa768,0xa764
    3e07:	a7 00 00 
    base.s.size = 0;
    3e0a:	bf 68 a7 00 00       	mov    $0xa768,%edi
    base.s.ptr = freep = prevp = &base;
    3e0f:	c7 05 68 a7 00 00 68 	movl   $0xa768,0xa768
    3e16:	a7 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3e19:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    3e1b:	c7 05 6c a7 00 00 00 	movl   $0x0,0xa76c
    3e22:	00 00 00 
    if(p->s.size >= nunits){
